"""Purpose: examples/ch11-python-as-a-notation/03-python_import.metta in Python: importing a .py file.
...
FIXTURE = S["examples/ch11-python-as-a-notation/_fixtures/python_import_file.py"]


def twin(m):
    """Import a Python file, then call two of its functions."""
    # (import! &self examples/ch11-python-as-a-notation/_fixtures/python_import_file.py):
...
#: RE-PINNED 2026-09-01, 1942 to 2156 (+214), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 2156 to 2150 (-6), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 2150 to 2164 (+14), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 2164 to 2199 (+35), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 2199 to 2206 (+7), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 2206 to 2296 (+90), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 2296 to 2287 (-9), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 2287 to 2472 (+185), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 2472 to 2313 (-159), The engine and library module
...
#: RE-PINNED 2026-09-08, 2313 to 2356 (+43), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 2356 to 2408 (+52), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 2356 to 2371 (+15), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 2371 to 2423 (+52), tokens as storage landed
...
#: RE-PINNED 2026-09-10, 2423 to 2402 (-21), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 2402 to 2462 (+60), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 2402 to 2482 (+80), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 2482 to 2472 (-10), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-24, 2472 to 2487 (+15), placed on the full-configuration
...
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 2487 to 2752 (+265), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:49:26+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2752 to 2753 (+1), every force of a waiting function
#: names the module it is made from, through fun_home_in/3, and a write forces
#: only its own space; the lanes' tree read this twin +2 off its pin before the
