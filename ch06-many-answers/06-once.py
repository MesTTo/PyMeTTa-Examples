"""Purpose: examples/ch06-many-answers/06-once.metta in Python: committing to the first answer.
...
PARAMETERS, and `match(space, pattern, template)` is the expression-position
ask a compiled body lowers to the instruction, so the space the call hands over
is the one the equation reads. The rest is ordinary Python: a write is
...
#: RE-PINNED 2026-08-25, 4126 to 4145, at the flat-door
...
#: RE-PINNED 2026-08-25, 4145 to 4151, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 4151 to 4120, on the release tree:
...
#: RE-PINNED 2026-08-25, 4120 to 4125, at the release cut: the
...
#: RE-PINNED 2026-08-26, 4125 to 5673 (+1548), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 5673 to 5693 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 5693 to 4227 (-1466), by the specializer
...
#: RE-PINNED 2026-09-01, 4227 to 3612 (-615), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3612 to 3601 (-11), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 3601 to 3610 (+9), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 3610 to 3662 (+52), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3662 to 3646 (-16), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3646 to 3660 (+14), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3660 to 3497 (-163), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3497 to 3580 (+83), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3580 to 3618 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 3618 to 3582 (-36), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 3582 to 3597 (+15), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 3582 to 3588 (+6), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3588 to 3598 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 3598 to 3589 (-9), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 3597 to 3634 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 3634 to 3609 (-25), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 3609 to 3654 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 3589 to 3752 (+163), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 3752 to 3692 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 3692 to 3802 (+110), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3589 to 3636 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3636 to 3727 (+91), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 3727 to 3845 (+118), the compiled vocabulary seed, the
...
#: tree, +43 against the trunk's own pin of 3802 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +75 is what landed
...
#: RE-PINNED 2026-09-09, 3845 to 3905 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 3905 to 3915 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 3915 to 3908 (-7), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 3908 to 2761 (-1147), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 3908 to 2972 (-936), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 2972 to 2942 (-30), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 2942 to 2958 (+16), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 2958 to 2966 (+8), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 2966 to 2956 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:29+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2956 to 2909 (-47), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:42:40+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2909 to 2910 (+1), every force of a waiting function
