...
#: RE-PINNED 2026-09-01, 9422 to 9445 (+23), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 9445 to 9787 (+342), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 9787 to 9806 (+19), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 9806 to 9815 (+9), P43 protects both generated policy-
#: check fallbacks from space-local capture [measured 2026-09-02: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 9815 to 9347 (-468), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 9347 to 9649 (+302), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 9649 to 9683 (+34), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 9683 to 9622 (-61), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 9622 to 9612 (-10), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 9612 to 9631 (+19), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 9680 to 9690 (+10), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 9631 to 9664 (+33), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 9664 to 9708 (+44), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 9708 to 9792 (+84), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 9690 to 9874 (+184), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 9874 to 9814 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 9814 to 9956 (+142), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 9690 to 9643 (-47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 9643 to 9810 (+167), the compiled vocabulary seed, the
...
#: tree, -146 against the trunk's own pin of 9956 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +313 is what landed
...
#: RE-PINNED 2026-09-09, 9810 to 9875 (+65), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 9875 to 9880 (+5), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 9880 to 9866 (-14), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 9866 to 8968 (-898), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 9866 to 16232 (+6366), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 16237 to 15956 (-281), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 15956 to 16017 (+61), the sixty libraries derived in
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-24, 16000 to 16005 (+5), 5c32234cf, the host-patch split,
...
#: RE-PINNED 2026-09-24, 16005 to 16000 (-5), 0847c3d4c decides a platform
...
#: RE-PINNED 2026-09-24, 16000 to 16019 (+19), +20 at 850d2a660, which reads a
...
#: RE-PINNED 2026-09-25, 15150 to 15140 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:29:34+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 15140 to 14909 (-231), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:48:49+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 14909 to 14910 (+1), every force of a waiting function
...
DIVERGENCE = "ebd72579bd6332d99e221eec2c82a37abd9cf3029fac67379d0e312c42d7780a"

#: OVERRUN 2026-09-18, 0 to 1404 (+1404): the twin costs 16232 against the
#: example's 10893 and a ceiling of 14828 with the earlier declaration; a
