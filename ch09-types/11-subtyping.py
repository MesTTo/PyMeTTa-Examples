...
#: RE-PINNED 2026-09-01, 10043 to 10020 (-23), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 10020 to 10058 (+38), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 10058 to 10339 (+281), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 10339 to 10327 (-12), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 10327 to 10337 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 10337 to 10253 (-84), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 10253 to 10482 (+229), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 10482 to 10521 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 10521 to 10510 (-11), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 10510 to 10489 (-21), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 10489 to 10506 (+17), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 10489 to 10534 (+45), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 10534 to 10544 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 10544 to 10619 (+75), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 10506 to 10543 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 10543 to 10639 (+96), the door table landed
...
#: RE-PINNED 2026-09-09, 10639 to 10769 (+130), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 10619 to 10863 (+244), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 10863 to 10803 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 10803 to 10998 (+195), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 10619 to 10535 (-84), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 10535 to 10815 (+280), the compiled vocabulary seed,
...
#: tree, -183 against the trunk's own pin of 10998 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +463 is what landed
...
#: RE-PINNED 2026-09-09, 10815 to 10875 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 10875 to 10885 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 10885 to 10866 (-19), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 10866 to 10049 (-817), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 10866 to 13924 (+3058), the branch's landings since
...
#: RE-PINNED 2026-09-18, 13924 to 13725 (-199), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 13725 to 13744 (+19), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 13744 to 13753 (+9), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 13753 to 13743 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:29:29+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 13743 to 13539 (-204), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:48:44+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 13539 to 13540 (+1), every force of a waiting function
...
DIVERGENCE = "d87f8281d1e607016f84523dad5a3e509e45905112d9e78028df40d7b3d53954"
