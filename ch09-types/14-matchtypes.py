"""Purpose: examples/ch09-types/14-matchtypes.metta in Python: types compared as ordinary atoms.
...
#: RE-PINNED 2026-09-01, 10096 to 3917 (-6179), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3917 to 3901 (-16), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 3901 to 3930 (+29), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 3930 to 4044 (+114), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4044 to 4052 (+8), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 4052 to 3924 (-128), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3924 to 4117 (+193), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4117 to 4042 (-75), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4042 to 4024 (-18), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 4024 to 4039 (+15), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4039 to 4123 (+84), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 4123 to 4226 (+103), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 4123 to 4222 (+99), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 4222 to 4325 (+103), tokens as storage landed
...
#: RE-PINNED 2026-09-09, 4123 to 4363 (+240), Compile shipped typing decisions
...
#: RE-PINNED 2026-09-09, 4363 to 4565 (+202), the compiled vocabulary seed, the
...
#: tree, +240 against the trunk's own pin of 4325 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining -38 is what landed
...
#: RE-PINNED 2026-09-10, 4565 to 4483 (-82), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 4483 to 4475 (-8), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 4483 to 3858 (-625), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 3858 to 3838 (-20), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 3838 to 3862 (+24), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 3862 to 6308 (+2446), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:48:51+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 6308 to 6309 (+1), every force of a waiting function
