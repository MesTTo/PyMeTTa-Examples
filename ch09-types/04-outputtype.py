"""Purpose: examples/ch09-types/04-outputtype.metta in Python: the output type decides.
...
#: RE-PINNED 2026-08-26, 10078 to 10098 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 10098 to 8658 (-1440), by the specializer
...
#: RE-PINNED 2026-09-01, 8658 to 7980 (-678), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 7980 to 7957 (-23), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 8017 to 8428 (+411), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 8428 to 8438 (+10), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 8438 to 8448 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 8448 to 7985 (-463), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 7985 to 8161 (+176), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 8161 to 8204 (+43), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 8204 to 8140 (-64), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 8140 to 8131 (-9), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 8131 to 8156 (+25), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 8131 to 8156 (+25), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 8156 to 8166 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 8166 to 8177 (+11), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 8156 to 8191 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 8191 to 8197 (+6), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 8197 to 8259 (+62), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 8177 to 8499 (+322), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 8499 to 8439 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 8439 to 8566 (+127), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 8177 to 8205 (+28), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 8205 to 8196 (-9), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 8196 to 8490 (+294), the compiled vocabulary seed, the
...
#: tree, -76 against the trunk's own pin of 8566 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +370 is what landed
...
#: RE-PINNED 2026-09-09, 8490 to 8550 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 8550 to 8560 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 8560 to 8542 (-18), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 8542 to 7558 (-984), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 8542 to 8659 (+117), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 8659 to 8456 (-203), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 8456 to 8490 (+34), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 8490 to 8497 (+7), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 8497 to 8487 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:29:21+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 8487 to 8295 (-192), the host evaluation door replaces
...
DIVERGENCE = "00e16807b07a3f86fa39bfff89c14feaec15dec6df2c29eac77a4342858eee74"
