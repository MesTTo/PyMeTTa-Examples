"""Purpose: examples/ch09-types/15-engine_surface.metta in Python: the engine's own type surface.
...
[source: examples/ch09-types/15-engine_surface.metta:22; commit=f053d9d46aa43b9beec360eae30b9016ffbf231f]
"""
...
#: RE-PINNED 2026-08-26, 13865 to 14121 (+256), by the open-tail-index
...
#: RE-PINNED 2026-09-01, 17410 to 17362 (-48), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 17362 to 17374 (+12), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 17374 to 17682 (+308), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 17682 to 17810 (+128), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 17810 to 18454 (+644), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 18454 to 18459 (+5), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 18459 to 18449 (-10), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 18449 to 19027 (+578), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 19027 to 19072 (+45), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 19072 to 19122 (+50), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 19072 to 19219 (+147), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 19219 to 19269 (+50), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 19072 to 18934 (-138), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 18934 to 19131 (+197), the compiled vocabulary seed,
...
#: tree, -138 against the trunk's own pin of 19269 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +335 is what landed
...
#: RE-PINNED 2026-09-10, 19131 to 18742 (-389), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 18742 to 19597 (+855), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 18742 to 20100 (+1358), the branch's landings since
...
#: RE-PINNED 2026-09-18, 20100 to 19839 (-261), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-24, 19839 to 19845 (+6), +6 at 850d2a660, which reads a
...
#: RE-PINNED 2026-09-25, 19845 to 19342 (-503), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:48:54+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 19342 to 19343 (+1), every force of a waiting function
