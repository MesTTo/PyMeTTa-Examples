"""Purpose: examples/ch04-spaces-and-matching/04-02-patterns-and-bindings/06-listhead.metta in Python: list structure, twice over.
...
#: RE-PINNED 2026-08-26, 9424 to 9444 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 9444 to 8004 (-1440), by the specializer
...
#: RE-PINNED 2026-09-01, 8004 to 5425 (-2579), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 5425 to 5412 (-13), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 5425 to 5485 (+60), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 5485 to 5473 (-12), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 5473 to 5483 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 5483 to 4824 (-659), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4824 to 4985 (+161), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4985 to 5022 (+37), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 5022 to 4959 (-63), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4959 to 4953 (-6), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 4953 to 4971 (+18), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4953 to 4978 (+25), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4978 to 4988 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 4988 to 4980 (-8), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 4971 to 5028 (+57), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 5028 to 5020 (-8), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 5020 to 5065 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 4980 to 5133 (+153), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 5133 to 5073 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 5073 to 5203 (+130), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 4980 to 5029 (+49), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 5029 to 5059 (+30), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 5059 to 5187 (+128), the compiled vocabulary seed, the
...
#: tree, -16 against the trunk's own pin of 5203 at da0e5755d; the previous
...
#: RE-PINNED 2026-09-09, 5187 to 5247 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 5247 to 5257 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 5257 to 5252 (-5), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 5252 to 4144 (-1108), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 5252 to 4312 (-940), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 4312 to 4263 (-49), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 4263 to 4286 (+23), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 4286 to 4307 (+21), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 4307 to 4292 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:25:29+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4292 to 4199 (-93), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:40:35+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4199 to 4200 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "7c5f129140bdf425ce7cb565305a484c7fd905043885316dd456d80fe90da6b5"
