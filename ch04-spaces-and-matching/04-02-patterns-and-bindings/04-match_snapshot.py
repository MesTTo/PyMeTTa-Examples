...
#: RE-PINNED 2026-09-01, 4998 to 5198 (+200), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 5198 to 4962 (-236), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 4962 to 5101 (+139), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 5101 to 5156 (+55), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 5156 to 5136 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 5136 to 5146 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 5146 to 4699 (-447), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4699 to 4863 (+164), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4863 to 4901 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 4901 to 4797 (-104), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 4797 to 4792 (-5), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 4792 to 4810 (+18), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4792 to 4955 (+163), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4955 to 4965 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 4965 to 5011 (+46), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 4810 to 4867 (+57), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 4867 to 5051 (+184), the door table landed
...
#: RE-PINNED 2026-09-09, 5051 to 5178 (+127), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 5011 to 5377 (+366), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 5377 to 5317 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 5317 to 5529 (+212), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 5011 to 5058 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 5058 to 5342 (+284), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 5342 to 5764 (+422), the compiled vocabulary seed, the
...
#: tree, +235 against the trunk's own pin of 5529 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +187 is what landed
...
#: RE-PINNED 2026-09-09, 5764 to 5824 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 5824 to 5834 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 5834 to 5822 (-12), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 5822 to 4477 (-1345), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 5822 to 4646 (-1176), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 4646 to 4638 (-8), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 4638 to 4682 (+44), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 4682 to 4688 (+6), placed on the full-configuration
...
#: that took lib_statistics and lib_random to green; da91bc244 confines an
#: exact removal's selection to its own atom: native_retract_one/2 now records
#: the selected clause's head, a clause/3 lookup per exact removal, and checks
#: each removal made while the selector is live against it, a few inferences
#: per removal (+8 on most twins, +24 to +192 on the library twins that
#: withdraw package rows) [measured 2026-09-24: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-24, 4688 to 4694 (+6), +6 at 850d2a660, which reads a
...
#: RE-PINNED 2026-09-25, 4694 to 4679 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:25:24+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4679 to 5313 (+634), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:40:29+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 5313 to 5314 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "82b27b59811ce9149603e5a58ae7c9b81a34b95863ebd4cf311514005435e80b"
