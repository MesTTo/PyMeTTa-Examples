"""Purpose: examples/ch04-spaces-and-matching/04-01-a-space-is-where-a-program-lives/09-selfprog.metta in Python: a program editing itself.
...
#: RE-PINNED 2026-08-26, 5231 to 5249 (+18), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 5249 to 5269 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 5269 to 4890 (-379), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 4890 to 4942 (+52), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 4942 to 4874 (-68), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 4874 to 4883 (+9), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 4883 to 4986 (+103), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4986 to 4966 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4966 to 4976 (+10), P43 protects both generated
...
#: RE-PINNED 2026-09-06, 4984 to 4108 (-876), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4108 to 4183 (+75), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4183 to 4221 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 4221 to 4203 (-18), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4203 to 4198 (-5), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 4198 to 4215 (+17), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4198 to 4209 (+11), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4209 to 4219 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 4219 to 4210 (-9), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 4215 to 4252 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 4252 to 4230 (-22), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 4230 to 4275 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 4210 to 4642 (+432), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 4642 to 4582 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 4582 to 4692 (+110), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 4210 to 4256 (+46), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 4256 to 4643 (+387), the compiled vocabulary seed, the
...
#: tree, -49 against the trunk's own pin of 4692 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +436 is what landed
...
#: RE-PINNED 2026-09-09, 4643 to 4703 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 4703 to 4713 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 4713 to 4671 (-42), Receipt cleanup stops at the
...
#: RE-PINNED 2026-09-10, 4671 to 4653 (-18), The receipt crash repair replaces
#: the separate nesting enumeration with metta_receipt_nearest_frame/3 and
#: metta_receipt_watch_transaction/2, transferring the same scope at live
...
#: command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=8ca8a387fc61d0918484b19a1a3baf85b6523043].
#: RE-PINNED 2026-09-11, 4653 to 3499 (-1154), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 4653 to 3763 (-890), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 3763 to 3717 (-46), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 3717 to 3749 (+32), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 3749 to 3762 (+13), placed on the full-configuration
...
#: RE-PINNED 2026-09-24, 3762 to 3676 (-86), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-82); gate-perf's
...
#: RE-PINNED 2026-09-25, 3676 to 3666 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:25:14+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3666 to 3940 (+274), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:40:13+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3940 to 3941 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 3941 to 3946 (+5), the erase audit routes three engine
#: releases through host_transactions:try_erase/1, whose ignore/1 frame costs
#: about 1.5 inferences more per release than the bare erase/1 it replaces: a
#: forgotten specialization's clauses and an equation's token and binding rows
#: (engine/filereader.pl), a removed equation's two function-metadata rows
#: (engine/translator/analysis.pl) and a typing rule's entry
