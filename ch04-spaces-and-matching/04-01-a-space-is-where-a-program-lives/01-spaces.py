"""Purpose: examples/ch04-spaces-and-matching/04-01-a-space-is-where-a-program-lives/01-spaces.metta in Python: writes a later match can see.
...
#: RE-PINNED 2026-08-25, 6040 to 6045, at the release cut: the
...
#: RE-PINNED 2026-08-26, 6045 to 6120 (+75), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 6120 to 6140 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 6140 to 3607 (-2533), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3607 to 3600 (-7), the subtract-atom primitive and the
...
#: RE-PINNED 2026-09-02, 3600 to 3652 (+52), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3652 to 3632 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3632 to 3642 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3642 to 3671 (+29), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3671 to 3848 (+177), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3848 to 3886 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 3886 to 3762 (-124), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 3762 to 3776 (+14), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 3762 to 3774 (+12), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3774 to 3784 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 3784 to 3762 (-22), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 3776 to 3813 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 3813 to 3782 (-31), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 3782 to 3810 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 3762 to 3911 (+149), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 3911 to 3851 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 3851 to 3944 (+93), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3762 to 3809 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3809 to 3902 (+93), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 3902 to 3989 (+87), the compiled vocabulary seed, the
...
#: tree, +45 against the trunk's own pin of 3944 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +42 is what landed
...
#: RE-PINNED 2026-09-09, 3989 to 4049 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 4049 to 4059 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 4059 to 4053 (-6), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 4053 to 2860 (-1193), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 4053 to 2996 (-1057), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 2996 to 2974 (-22), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 2974 to 3026 (+52), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 3026 to 3013 (-13), the registration refusal kind
...
#: the base [measured 2026-09-25T06:24:56+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3013 to 3294 (+281), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:39:52+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3294 to 3295 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "78e62c3ab30f41ecb0d4fabaa81cbfc33efd0259c27ebd52d3064f95d0bdfddc"
