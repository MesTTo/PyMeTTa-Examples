...
#: RE-PINNED 2026-09-10, 31375 to 29827 (-1548), the binding resolves Janus
...
#: four below the old point, so its unchanged tolerance left that point
#: standing. A 32-worker cut/current control locates the scheduler's four-
#: inference spread at 31372..31376 and 29819..29823 respectively. These 32
#: fresh serial samples settle the shifted point; the four-inference allowance
