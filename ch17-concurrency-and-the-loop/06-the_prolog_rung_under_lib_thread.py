...
#: RE-OBSERVED 2026-09-18 under 'full-lane/294/workers=32', 153184..154113 over
#: 10 under 'full-lane/293/workers=32' to 152824..154546 over 10: the corpus
...
#: RE-OBSERVED 2026-09-18 under 'full-lane/294/workers=32', 152824..154546 over
#: 10 under 'full-lane/294/workers=32' to 152493..154546 over 23: every full-
...
#: RE-OBSERVED 2026-09-18 under 'full-lane/294/workers=32', 152493..154546 over
#: 23 under 'full-lane/294/workers=32' to 152493..154546 over 24: every full-
#: lane run under one protocol is an observation, so the envelope pools the two
...
#: RE-OBSERVED 2026-09-18 under 'full-lane/294/workers=32', 152493..154546 over
#: 24 under 'full-lane/294/workers=32' to 152493..154546 over 25: every full-
#: lane run under one protocol is an observation, so the envelope pools the two
...
#: RE-OBSERVED 2026-09-19 under 'full-lane/294/workers=32', 151672..152620 over
#: 10 under 'full-lane/294/workers=32' to 139741..141733 over 10: cost follows
...
#: ENVELOPED 2026-09-19: the envelope 139741..141733 over 10 becomes the
#: envelope 139741..141754 over 11: under the lane's own protocol (full-
#: lane/294/workers=32, ten rounds) the counter reads 139741 every time, and
#: with the lane alone on the final tree (one run, the continuous envelope's
#: 2/(n+1) stray) it reads 141754, each reading exact on its run; the extra
...
#: time=9223372036854775807/before-boot', 139741..141754 to 486276..487664 over
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 486276..487664 to 485951..488420 over
...
#: time=9223372036854775807/before-boot', 485951..488420 to 491481..494212 over
...
#: time=9223372036854775807/before-boot', 491481..494212 over 20 to
#: 491481..494212 over 28: the 8 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 491499; the pin run's second
#: lane 492105; the pin run's third lane 492795; the first final lane 492218;
#: the purged lane on 49e2b250d 492839; the purged lane on 26de4ddcf 492875;
#: the purged lane after a8487162 492270; the purged lane after 878b8bd9
#: 493109. They are the pin run's own lanes on the 6a7ac233d snapshot and the
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 491481..494212 to 197259..199251 over
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 197259..199251 to 208137..210171 over
...
#: went from 197,991 to 210,153; gate-perf's ae1cc8936 walks the visible
...
#: registers such a batch (+12,264); the other 42 rungs that moved it net -102,
#: the largest single step 1,990, inside the 2,034 this reading scatters by on
#: one tree (its full-lane observations on the fixed tree spread 2,034), and
#: the band's midpoint moved +10,899; an empirical envelope is a claim about
#: one scheduler's protocol on one tree, so these observations are this tree's
#: own and are not pooled with the earlier ones [measured 2026-09-24: 21 full-
#: lane observations on the fixed tree, the twenty rounds of --observe and one
