...
#: RE-PINNED 2026-09-18, 8606342 to 8596140 (-10202), the trunk merged
...
#: RE-PINNED 2026-09-19, 8596140 to 8598216 (+2076), cost follows the answer: a
...
#: ENVELOPED 2026-09-19: the point 8598216 becomes the envelope
#: 8598216..8620104 over 11: under the lane's own protocol (full-
#: lane/294/workers=32, ten rounds) the counter reads 8598216 every time, and
#: under the gate's concurrent lanes (three runs) it reads 8620104, each
...
#: time=9223372036854775807/before-boot', 8598216..8620104 to 6682577..6682577
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 6682577..6682577 to 6682577..6682577
...
#: time=9223372036854775807/before-boot', 6682577..6682577 to 6193857..6193857
...
#: time=9223372036854775807/before-boot', 6193857..6193857 over 20 to
#: 6193857..6193857 over 28: the 8 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 6193857; the pin run's second
#: lane 6193857; the pin run's third lane 6193857; the first final lane
#: 6193857; the purged lane on 49e2b250d 6193857; the purged lane on 26de4ddcf
#: 6193857; the purged lane after a8487162 6193857; the purged lane after
#: 878b8bd9 6193857. They are the pin run's own lanes on the 6a7ac233d snapshot
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 6193857..6193857 to 5887778..5888230
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5887778..5888230 to 5355226..5355226
...
#: its twin went from 5,885,888 to 5,355,226 (at 0a81c782f the serial protocol
#: read 1,890 under the full lane's 5,887,778..5,888,230, and on the fixed tree
...
#: first read (+5,759); its 984eabe23 keeps the verdict in a flag decided under
#: a mutex (-1,494); provider-carry's aaeea643a carries a provider's stored
#: term back as the engine gave it (+1,569); 4890e870d gives the governed QLF
#: set one producer (+780); gate-perf's b7e3d3bcb keeps each reference head's
#: last bind in its own row, so a from row rebinds only the heads it brings
#: (-117,444); gate-perf's ae1cc8936 walks the visible predicate table once for
#: a batch of 13 to 40 registered names, two inferences a visible predicate,
#: about 11,500 for each library import that registers such a batch (+11,025);
#: provider-carry's 850d2a660 reads a native space's lengths in ascending order
#: (-15); provider-carry's 1748f6a06 asks early-exit questions by key or in
#: ascending arity (+30); the packages job's b5eb39acd names get-property's and
#: setup!'s subject by a from source's rule (-1,644); d4a365c16 holds the
#: support graph's visited set and the reference refresh's space sets in tries
#: instead of library(nb_set) (-427,002); gate-perf's d781eab8f copies a
#: withdrawn equation once (+652); the packages job's registration service,
#: 90be572a9 in the engine with 4003462fe in the seat, net (-2,878); until
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5355226..5355226 to 5177610..5177610
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5189852..5189852 to 5193782..5193782
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5193782..5193782 to 5187890..5187890
...
#: time=9223372036854775807/before-boot', 5187890..5187890 to 5187827..5187827
...
#: --observe --rounds 20].
#: RE-OBSERVED 2026-09-25 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5187827..5187827 to 5197878..5197878
