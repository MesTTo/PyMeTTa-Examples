...
#: time=9223372036854775807/before-boot', 7364363..7387049 to 6577606..6577606
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 6577606..6577606 to 6577606..6577606
...
#: time=9223372036854775807/before-boot', 6577606..6577606 to 6460447..6460447
...
#: time=9223372036854775807/before-boot', 6460447..6460447 over 20 to
#: 6460447..6460447 over 28: the 8 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 6460447; the pin run's second
#: lane 6460447; the pin run's third lane 6460447; the first final lane
#: 6460447; the purged lane on 49e2b250d 6460447; the purged lane on 26de4ddcf
#: 6460447; the purged lane after a8487162 6460447; the purged lane after
#: 878b8bd9 6460447. They are the pin run's own lanes on the 6a7ac233d snapshot
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 6460447..6460447 to 6160740..6161208
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 6160740..6161208 to 5612383..5612384
...
#: its twin went from 6,160,155 to 5,612,383 (at 0a81c782f the serial protocol
#: read 585 under the full lane's 6,160,740..6,161,208, and on the fixed tree
...
#: first read (+5,894); its 984eabe23 keeps the verdict in a flag decided under
#: a mutex (-4,650); provider-carry's aaeea643a carries a provider's stored
#: term back as the engine gave it (+4,985); 4890e870d gives the governed QLF
#: set one producer (-1,290); gate-perf's b7e3d3bcb keeps each reference head's
#: last bind in its own row, so a from row rebinds only the heads it brings
#: (-196,458); gate-perf's ae1cc8936 walks the visible predicate table once for
#: a batch of 13 to 40 registered names, two inferences a visible predicate,
#: about 11,500 for each library import that registers such a batch (+12,347);
#: provider-carry's 850d2a660 reads a native space's lengths in ascending order
#: (+280); provider-carry's 1748f6a06 asks early-exit questions by key or in
#: ascending arity (+27); the packages job's b5eb39acd names get-property's and
#: setup!'s subject by a from source's rule (-653); d4a365c16 holds the support
#: graph's visited set and the reference refresh's space sets in tries instead
#: of library(nb_set) (-364,101); gate-perf's d781eab8f copies a withdrawn
#: equation once (+1,649); the packages job's registration service, 90be572a9
#: in the engine with 4003462fe in the seat, net (-5,802); until d4a365c16 this
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5612383..5612384 to 5435453..5435453
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5435453..5435453 to 5444405..5444405
#: over 20 observations: the tree moved under this envelope by the change this
...
#: time=9223372036854775807/before-boot', 5440730..5440730 to 5440244..5440244
...
#: --observe --rounds 20].
#: RE-OBSERVED 2026-09-25 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 5440244..5440244 to 5442447..5442447
