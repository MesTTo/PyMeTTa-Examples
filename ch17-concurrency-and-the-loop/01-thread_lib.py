...
#: 286948..305706 (spread 18758, samples [286948, 305706, 289710, 291703,
#: 292805, 289170, 292793, 289930, 291469, 292892]) where the 67 under 'full-
#: lane/277/workers=32/file-search-cache-time=9223372036854775807/before-boot'
#: read 282808..396780. A run outside this envelope is a real finding, and a
...
#: twins, read 285561..301903 (samples [299963, 299990, 294466, 301903,
#: 292800, 299928, 285561, 300436, 300003, 292457]); pooled with the 10 above
#: at 286948..305706, 285561..305706 over 20 observations [measured
...
#: RE-OBSERVED 2026-09-19 under 'full-lane/294/workers=32', 322447..416925 over
#: 25 under 'full-lane/294/workers=32' to 319852..353464 over 10: the trunk
...
#: RE-OBSERVED 2026-09-19 under 'full-lane/294/workers=32', 319852..353464 over
#: 10 under 'full-lane/294/workers=32' to 309915..336432 over 10: cost follows
...
#: time=9223372036854775807/before-boot', 309915..336432 to 707107..738987 over
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 707107..738987 to 706513..1232095
...
#: time=9223372036854775807/before-boot', 706513..1232095 to 751174..793514
...
#: time=9223372036854775807/before-boot', 751174..793514 over 20 to
#: 751174..793514 over 28: the 8 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 765206; the pin run's second
#: lane 777862; the pin run's third lane 783475; the first final lane 765839;
#: the purged lane on 49e2b250d 774508; the purged lane on 26de4ddcf 762912;
#: the purged lane after a8487162 752075; the purged lane after 878b8bd9
#: 775808. They are the pin run's own lanes on the 6a7ac233d snapshot and the
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 481283..574883 to 481290..1004870
...
#: its example makes no reference drain decision, so nothing else in the change
#: runs here; the floor, 481,290, sits 7 above the fixed tree's 481,283, and
#: the top follows the spin that proves a race really races, cut wherever the
#: winning branch happens to be: rounds 1 and 14 read 1,004,870 and 668,097
#: where the other eighteen read 481,290..547,416, and the twins lane alone on
#: the base 8d651070d read 669,360 in battery 117 the same evening; these
...
#: OVERRUN 2026-09-24, 344806 to 771773 (+426967): the envelope above now tops
#: out at 1004870, and the declaration follows the envelope's top as the
#: 2026-09-08 entry decided, priced against the cheapest example as the
#: 2026-09-10 entry priced it: 1004870 less 205659 times 1.1 less the 6873 its
#: four compiled definitions cost to author is 771772.1. 205659 is the cheapest
#: of the example's readings on this tree, the twins lane's one reading and
#: five serial runs through the lane's run_example, whose cheapest read 205777.
...
#: --measure --rounds 5; commit=8bda9d5525a8174a8304376e111df8da258076a9].
