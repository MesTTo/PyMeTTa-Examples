...
#: time=9223372036854775807/before-boot', 121129..121932 to 467127..467173 over
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 467127..467173 to 467127..467597 over
...
#: commit=WORKTREE].
#: POOLED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 473082..473840 over 22 to
#: 473082..473840 over 28: the 6 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 473086; the first final lane
#: 473086; the purged lane on 49e2b250d 473086; the purged lane on 26de4ddcf
#: 473086; the purged lane after a8487162 473145; the purged lane after
#: 878b8bd9 473086. They are the pin run's own lanes on the 6a7ac233d snapshot
...
#: of the counts [measured 2026-09-24: 6 whole-lane runs, sh
#: extensions/python/check.sh twins in battery 5; command=python
#: extensions/python/tools/twin_coverage.py; commit=WORKTREE].
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 473082..473840 to 178217..178990 over
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 178217..178990 to 189740..189799 over
...
#: went from 178,221 to 189,740; gate-perf's ae1cc8936 walks the visible
...
#: registers such a batch (+11,547); the other 23 rungs that moved it net -28,
#: the largest single step 345, inside the 345 this reading scatters by on one
#: tree (its full-lane observations on the fixed tree spread 59), and the
#: band's midpoint moved +11,166; an empirical envelope is a claim about one
#: scheduler's protocol on one tree, so these observations are this tree's own
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 189740..189799 to 189746..189788 over
...
#: its example reading 203,258 against the base 8d651070d's 203,256 in one
#: battery path; this twin's count also follows its threads' schedule, so its
#: twenty rounds stayed inside the old band while the twins lane on this tree
#: read outside it, the paragraph below, and the envelope takes this tree's own
...
#: did not hold, the twins lane alone on 8d651070d with the change this
#: envelope lands with, read 189,746 in battery 117's pass over the base, this
#: change and the change after it, then 190,511 and 189,742 in two runs with
#: this change's twins; this twin's count follows its threads' schedule, and a
#: whole-lane run under this protocol on this runtime is an observation, so the
