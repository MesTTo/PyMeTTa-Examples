"""Purpose: examples/ch12-testing/02-he_equalreduct.metta in Python: equality and reduction, HE's vocabulary.
...
#: RE-PINNED 2026-09-01, 3083 to 3161 (+78), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3161 to 3151 (-10), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 3151 to 3165 (+14), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 3165 to 3225 (+60), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3225 to 3233 (+8), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3233 to 3127 (-106), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3127 to 3211 (+84), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3211 to 3199 (-12), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 3199 to 3191 (-8), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 3191 to 3214 (+23), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3214 to 3256 (+42), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 3256 to 3308 (+52), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 3256 to 3324 (+68), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 3324 to 3376 (+52), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3256 to 3250 (-6), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3250 to 3370 (+120), the compiled vocabulary seed, the
...
#: tree, -6 against the trunk's own pin of 3376 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +126 is what landed
...
#: RE-PINNED 2026-09-10, 3370 to 3348 (-22), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 3348 to 28191 (+24843), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 3348 to 29823 (+26475), the branch's landings since
...
#: RE-PINNED 2026-09-18, 29823 to 29297 (-526), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 29297 to 29590 (+293), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 29590 to 33458 (+3868), placed on the full-
...
#: RE-PINNED 2026-09-24, 33458 to 33393 (-65), d4a365c16 holds the support
...
#: RE-PINNED 2026-09-25, 33393 to 33388 (-5), the registration refusal kind
...
#: the base [measured 2026-09-25T06:30:02+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 33388 to 33988 (+600), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:49:46+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 33988 to 33989 (+1), every force of a waiting function
