"""Purpose: examples/ch07-control-flow/07-05-recursion/03-fibsmart.metta in Python: the accumulator fib.
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 10885 to 10574 (-311), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 10574 to 10832 (+258), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 10832 to 10880 (+48), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 10880 to 10789 (-91), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 10789 to 10807 (+18), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 10789 to 10986 (+197), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 10986 to 10996 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 10996 to 10978 (-18), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 10807 to 10860 (+53), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 10860 to 11016 (+156), the door table landed
...
#: RE-PINNED 2026-09-09, 11016 to 11044 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 10978 to 11216 (+238), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 11216 to 11156 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 11156 to 11267 (+111), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 10978 to 10997 (+19), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 10997 to 11117 (+120), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 11117 to 11311 (+194), the compiled vocabulary seed,
...
#: tree, +44 against the trunk's own pin of 11267 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +150 is what landed
...
#: RE-PINNED 2026-09-09, 11311 to 11371 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 11371 to 11381 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 11381 to 11430 (+49), The fixed diagnostic reader now
...
#: names both, so a one-form example is priced against two definitions plus
#: their call. Measured 10832 against a ceiling of 10351; a minimal twin of
#: this example costs 4852, inside the ceiling's 10351, so the distance is this
#: twin's own program [measured 2026-09-07: one fresh process per side;
#: command=python extensions/python/benchmarks/probes/twin_floor.py;
#: commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
#: OVERRUN 2026-09-08, 500 to 550 (+50, four of them the deterministic
...
#: makes pays it and the example pays none. Measured 10978 against a ceiling
#: of 10932; a minimal twin costs 4795 against the band's 10432, within that
...
#: OVERRUN 2026-09-09, 550 to 586 (+36): the door table landed
#: (feat/space-as-a-projection-of-door-rows merged at 6471faa37, its
#: reconciliation fixes at 58bf75947): every Space door is a generated alias
#: over its body, the catalog publishes the door contracts at boot as typed
#: atoms, and the seam's listeners publish on every registration, so boot
#: content and clause layout moved; every crossing this twin makes pays it and
#: the example pays none. Measured 11016 against a ceiling of 10980; a minimal
...
#: commit=aeb46b14152274db84f6415c8a3dd8c98a9c9eb1].
#: OVERRUN 2026-09-09, 586 to 759 (+173): the compiled vocabulary seed, the
...
#: trunk's own run at da0e5755d the twin moved +44 and the example +1, and the
#: twin sat 130 over its ceiling there already. Measured 11311 against a
#: ceiling of 11138; a minimal twin costs 5022 against the band's 10552,
...
#: command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "c2c6880f0377877acaec369a34fef07357c8fb7a0abdec86873774852aee0947"
