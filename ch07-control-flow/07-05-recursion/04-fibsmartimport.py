...
#: RE-PINNED 2026-09-01, 7105 to 7093 (-12), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 7093 to 7102 (+9), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 7102 to 7163 (+61), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 7163 to 7179 (+16), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 7179 to 7187 (+8), P43 protects both generated policy-
#: check fallbacks from space-local capture [measured 2026-09-02: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 7187 to 6890 (-297), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 6890 to 6912 (+22), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 6912 to 6900 (-12), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 6900 to 6945 (+45), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 6945 to 6974 (+29), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 6974 to 7009 (+35), structured concurrency landed
...
#: RE-PINNED 2026-09-09, 7083 to 7118 (+35), tokens as storage landed
...
#: RE-PINNED 2026-09-10, 7118 to 7092 (-26), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 7092 to 7075 (-17), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 7092 to 7240 (+148), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 7240 to 7192 (-48), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 7192 to 7308 (+116), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 7308 to 7328 (+20), placed on the full-configuration
...
#: dropped; d6e09995c retires a load's package rows from every space but its
#: library home after package_load/3, withdrawing each through
...
#: current only when every nested receipt does; where a twin's move exceeds
...
#: RE-PINNED 2026-09-25, 7328 to 7974 (+646), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:44:43+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 7974 to 8002 (+28), every force of a waiting function
