"""Purpose: examples/ch07-control-flow/07-05-recursion/05-iter.metta in Python: an iterator whose state is a number.
...
#: RE-PINNED 2026-08-25, 4840 to 4916, at the flat-door
...
#: RE-PINNED 2026-08-25, 4916 to 4927, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 4927 to 4867, on the release tree:
...
#: RE-PINNED 2026-08-25, 4867 to 4877, at the release cut: the
...
#: RE-PINNED 2026-08-26, 4877 to 4887 (+10), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 4887 to 4907 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 4907 to 3575 (-1332), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3575 to 3562 (-13), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 4593 to 4805 (+212), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4805 to 4796 (-9), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4796 to 4806 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 4806 to 4677 (-129), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4677 to 4789 (+112), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4789 to 4830 (+41), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 4830 to 4793 (-37), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4793 to 4781 (-12), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 4781 to 4801 (+20), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4781 to 4790 (+9), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4790 to 4800 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 4800 to 4822 (+22), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 4801 to 4838 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 4838 to 4921 (+83), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 4822 to 5035 (+213), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 5035 to 4975 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 4975 to 5119 (+144), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 4822 to 4864 (+42), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 4864 to 5062 (+198), the compiled vocabulary seed, the
...
#: tree, -57 against the trunk's own pin of 5119 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +255 is what landed
...
#: RE-PINNED 2026-09-09, 5062 to 5122 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 5122 to 5132 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 5132 to 5123 (-9), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 5123 to 3989 (-1134), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 5123 to 4965 (-158), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 4965 to 4870 (-95), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 4870 to 4885 (+15), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 4885 to 4892 (+7), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 4892 to 4882 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:27:46+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4882 to 4960 (+78), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:44:47+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4960 to 4961 (+1), every force of a waiting function
...
#: the twin holds 2 atoms the example does not (1 :, 1 =): a compiled body
...
#: extensions/python/tools/twin_coverage.py --repin; commit=6944d06ce96fdbcd1faefb640f15dbfa0cf286dd].
DIVERGENCE = "820da5b361539cee4de97c600d426fbdb7e53eecd1ef992b924b3d739cafc276"
