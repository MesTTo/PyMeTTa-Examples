"""Purpose: examples/ch07-control-flow/07-05-recursion/02-fib.metta in Python: the exponential fib, budgeted.
...
#: RE-PINNED 2026-09-01, 38846 to 29500 (-9346), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 29500 to 29493 (-7), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 32774 to 33339 (+565), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 33339 to 33417 (+78), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 33417 to 33427 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 33427 to 31123 (-2304), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 31123 to 31409 (+286), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 31409 to 31448 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 31448 to 31379 (-69), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 31379 to 31395 (+16), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 31379 to 31495 (+116), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 31495 to 31505 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 31505 to 31483 (-22), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 31395 to 31449 (+54), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 31449 to 31523 (+74), the door table landed
...
#: RE-PINNED 2026-09-09, 31523 to 31551 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 31483 to 31808 (+325), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 31808 to 31748 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 31748 to 31861 (+113), tokens as storage landed
...
#: RE-PINNED 2026-09-09, 31861 to 31763 (-98), the compiled vocabulary seed,
...
#: RE-PINNED 2026-09-09, 31763 to 31823 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 31823 to 31833 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 31833 to 31827 (-6), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 31827 to 30782 (-1045), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 31827 to 32687 (+860), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 32687 to 32077 (-610), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 32077 to 32169 (+92), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 32169 to 39095 (+6926), placed on the full-
...
#: RE-PINNED 2026-09-24, 39095 to 38705 (-390), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-390); each step read
...
#: RE-PINNED 2026-09-25, 38705 to 38692 (-13), the registration refusal kind
...
#: the base [measured 2026-09-25T06:27:41+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 38692 to 38693 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 38693 to 38701 (+8), the erase audit routes three
...
#: this was measured on already read -1 against the previous pin, trunk's own
#: offset inside its tolerance, so this change's share is +9 [measured
#: 2026-09-25T20:43:07+10:00: min-of-3 serial fresh processes; command=python
...
#: OVERRUN 2026-09-24, 0 to 2780: 814b99468 retains a self-call's function_view
...
#: each arrival through lib_memo's automatic reconcile (fib's rebuilds 1 to 2),
#: where the example's file load publishes its equations as one batch; that
#: difference, not the twin's own program, is what now puts it past its
#: example's band. Measured 39095 against the example's 31244, a band and
#: authoring ceiling of 36315.4 (1947 to author 1 compiled definition); the
#: floor probe's control costs 32518 [measured 2026-09-24: one fresh process
#: per side; command=python extensions/python/benchmarks/probes/twin_floor.py
#: examples/ch07-control-flow/07-05-recursion/02-fib.metta; commit=WORKTREE].
#: OVERRUN 2026-09-24, 2780 to 2810 (+30): the band is the example's cost plus
...
#: example -382 and the twin -390, the excess +30.2. Measured 38705 against the
#: example's 30862, a band and authoring ceiling of 35895.2 (1947 to author 1
#: compiled definition); the floor probe's control costs 32128 [measured
#: 2026-09-24: twin_coverage.py --measure, one fresh process per side, on each
#: tree, and the floor probe on the fixed tree; command=python
#: extensions/python/benchmarks/probes/twin_floor.py examples/ch07-control-
#: flow/07-05-recursion/02-fib.metta; commit=4ff69551e0e226442cf7257b96af858adda957a4].
OVERRUN = 2810
