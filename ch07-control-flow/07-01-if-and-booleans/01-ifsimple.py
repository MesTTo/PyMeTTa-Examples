...
#: RE-PINNED 2026-08-25, 4700 to 4719, at the flat-door
...
#: RE-PINNED 2026-08-25, 4719 to 4730, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 4730 to 4664, on the release tree:
...
#: RE-PINNED 2026-08-25, 4664 to 4674, at the release cut: the
...
#: RE-PINNED 2026-08-26, 4674 to 4668 (-6), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 4668 to 4688 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 4688 to 3182 (-1506), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3182 to 3175 (-7), the subtract-atom primitive and the
...
#: RE-PINNED 2026-09-01, 3175 to 3184 (+9), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 3184 to 3244 (+60), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3244 to 3224 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3224 to 3234 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3234 to 3542 (+308), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3542 to 3684 (+142), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3684 to 3722 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 3722 to 3650 (-72), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 3650 to 3664 (+14), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 3650 to 3678 (+28), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3678 to 3688 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 3688 to 3675 (-13), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 3664 to 3701 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 3701 to 3695 (-6), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 3695 to 3740 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-09, 3750 to 3860 (+110), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3675 to 3722 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3722 to 3760 (+38), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 3760 to 3850 (+90), the compiled vocabulary seed, the
...
#: tree, -10 against the trunk's own pin of 3860 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +100 is what landed
...
#: RE-PINNED 2026-09-09, 3850 to 3910 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 3910 to 3920 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 3920 to 2683 (-1237), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 2683 to 2678 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 2678 to 2683 (+5), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 2683 to 2723 (+40), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 2683 to 3003 (+320), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 3003 to 2983 (-20), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 2983 to 3019 (+36), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 3019 to 3012 (-7), the registration refusal kind makes
#: the (vocabulary refusal-kind ...) catalog row fifteen members long instead
#: of fourteen, which moves it from storage arity 17 to 18, where the Python
#: seat's (vocabulary door-answers ...) already sits, so &metta keeps one
#: storage arity fewer and each open-tail catalog lookup,
...
#: the base [measured 2026-09-25T06:26:34+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3012 to 3359 (+347), the host evaluation door replaces
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "5ae6d2b9cf7b119a43b104165c892acbbd121c9e1c6ea2b1e35561a577ea2cfc"

#: OVERRUN 2026-09-25, 0 to 233 (+233): the twin costs 3359 against the
#: example's 1072 and a ceiling of 3126 with the earlier declaration; a minimal
#: twin of this example costs 288, inside the 1179 the band alone allows, so
...
#: untranslated: this twin's first pull of keep(True, 42) costs 558 inferences
#: against 208, and every later ask the same as before [measured
