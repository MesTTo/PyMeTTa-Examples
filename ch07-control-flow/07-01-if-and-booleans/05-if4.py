...
#: against a definition plus its call. Measured 5424 against a ceiling of 4371;
#: a minimal twin of this example costs 1137, inside the ceiling's 4371, so the
...
#: OVERRUN 2026-09-08, 1100 to 1170 (+70, four of them the deterministic
...
#: crossing this twin makes pays it and the example pays none. Measured 5595
...
#: OVERRUN 2026-09-09, 1170 to 1186 (+16): the door table landed
#: (feat/space-as-a-projection-of-door-rows merged at 6471faa37, its
#: reconciliation fixes at 58bf75947): every Space door is a generated alias
#: over its body, the catalog publishes the door contracts at boot as typed
#: atoms, and the seam's listeners publish on every registration, so boot
#: content and clause layout moved; every crossing this twin makes pays it and
#: the example pays none. Measured 5613 against a ceiling of 5597; a minimal
...
#: OVERRUN 2026-09-09, 1190 to 1283 (+93): the compiled vocabulary seed, the
#: membership index, base-module type lookups and the singleton decoder landed
...
#: trunk's own run at da0e5755d the twin moved -64 and the example +0, and the
#: twin sat 156 over its ceiling there already. Measured 5709 against a
#: ceiling of 5617; a minimal twin costs 1169 against the band's 4427, within
