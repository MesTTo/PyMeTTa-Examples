"""Purpose: examples/ch07-control-flow/07-01-if-and-booleans/05-if4.metta in Python: an `if` inside a condition.
...
#: RE-PINNED 2026-08-25, 7167 to 7177, at the release cut: the
...
#: RE-PINNED 2026-08-26, 7177 to 7199 (+22), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 7199 to 4272 (-2927), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 4272 to 4263 (-9), the subtract-atom primitive and the
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 5105 to 5247 (+142), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 5247 to 5424 (+177), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 5424 to 5466 (+42), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 5466 to 5406 (-60), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 5406 to 5421 (+15), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 5406 to 5608 (+202), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 5608 to 5618 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 5618 to 5595 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 5421 to 5454 (+33), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 5454 to 5613 (+159), the door table landed
...
#: RE-PINNED 2026-09-09, 5613 to 5641 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 5595 to 5742 (+147), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 5742 to 5682 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 5682 to 5773 (+91), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 5595 to 5626 (+31), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 5626 to 5709 (+83), the compiled vocabulary seed, the
...
#: tree, -64 against the trunk's own pin of 5773 at da0e5755d; the previous
...
#: RE-PINNED 2026-09-09, 5709 to 5769 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 5769 to 5779 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 5779 to 4377 (-1402), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 4377 to 4372 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 4372 to 4378 (+6), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 4378 to 4482 (+104), end-of-wave re-pin on the merged
...
#: 1120 of it: the first use of the lowering paths its 1 definition take, which
...
#: RE-PINNED 2026-09-18, 4709 to 4646 (-63), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 4646 to 4678 (+32), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 4678 to 4668 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:44+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4668 to 4897 (+229), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:08+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4897 to 4898 (+1), every force of a waiting function
...
#: OVERRUN 2026-09-25, 1120 to 1128 (+8): the twin costs 4897 against the
#: example's 1657 and a ceiling of 4889 with the earlier declaration; a minimal
#: twin of this example costs 1109, inside the 1823 the band alone allows, so
...
#: translation once [measured 2026-09-25T07:04:38+10:00: one fresh process per
