"""Purpose: examples/ch07-control-flow/07-01-if-and-booleans/04-if3.metta in Python: an unbound variable IS one.
...
#: RE-PINNED 2026-08-25, 7034 to 7039, at the release cut: the
...
#: RE-PINNED 2026-08-26, 7039 to 7118 (+79), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 7118 to 7138 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 7138 to 4488 (-2650), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 4488 to 4475 (-13), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 4490 to 4483 (-7), exact numeric annotations retain
...
#: RE-PINNED 2026-09-02, 4483 to 4538 (+55), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4538 to 4526 (-12), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4526 to 4536 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 4536 to 4475 (-61), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4475 to 4611 (+136), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4611 to 4653 (+42), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 4653 to 4607 (-46), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4607 to 4620 (+13), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4807 to 4784 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 4655 to 4802 (+147), the door table landed
...
#: RE-PINNED 2026-09-08, 4784 to 4929 (+145), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 4929 to 4869 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 4869 to 4960 (+91), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 4784 to 4821 (+37), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 4821 to 4816 (-5), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 4816 to 4897 (+81), the compiled vocabulary seed, the
...
#: tree, -63 against the trunk's own pin of 4960 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +144 is what landed
...
#: RE-PINNED 2026-09-09, 4897 to 4957 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 4957 to 4967 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 4967 to 3574 (-1393), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 3574 to 3569 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 3569 to 3575 (+6), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 3575 to 3681 (+106), end-of-wave re-pin on the merged
...
#: OVERRUN 2026-09-11, 361: the band stopped granting the first-definition
...
#: longer pays it after the binding's boot import), and this twin still pays
#: 361 of it: the first use of the lowering paths its 1 definition take, which
#: the fixture's `return x + 1` does not exercise. Measured 3681 against a
#: ceiling of 3320 (1505 times 1.1 plus 303 once plus 1 times 1362) [measured
...
#: RE-PINNED 2026-09-18, 3575 to 3903 (+328), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 3903 to 3848 (-55), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 3848 to 3872 (+24), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 3872 to 3866 (-6), the registration refusal kind makes
...
#: the base [measured 2026-09-25T06:26:42+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3866 to 3803 (-63), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:05+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 3803 to 3804 (+1), every force of a waiting function
