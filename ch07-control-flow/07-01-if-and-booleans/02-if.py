"""Purpose: examples/ch07-control-flow/07-01-if-and-booleans/02-if.metta in Python: the three-argument `if`.
...
#: RE-PINNED 2026-08-25, 5444 to 5463, at the flat-door
...
#: RE-PINNED 2026-08-25, 5463 to 5474, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 5474 to 5408, on the release tree:
...
#: RE-PINNED 2026-08-25, 5408 to 5418, at the release cut: the
...
#: RE-PINNED 2026-08-26, 5418 to 5441 (+23), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 5441 to 2945 (-2496), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 2945 to 2938 (-7), the subtract-atom primitive and the
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 2980 to 3014 (+34), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3014 to 3096 (+82), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3096 to 3134 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 3134 to 3096 (-38), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 3096 to 3110 (+14), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 3096 to 3108 (+12), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3108 to 3118 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 3118 to 3095 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 3110 to 3147 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 3147 to 3115 (-32), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 3115 to 3143 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 3095 to 3230 (+135), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 3230 to 3170 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 3170 to 3263 (+93), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3095 to 3142 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3142 to 3215 (+73), the compiled vocabulary seed, the
...
#: tree, -48 against the trunk's own pin of 3263 at da0e5755d; the previous
...
#: RE-PINNED 2026-09-09, 3215 to 3275 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 3275 to 3285 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 3285 to 2048 (-1237), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 2048 to 2043 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 2043 to 2048 (+5), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 2048 to 2085 (+37), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 2048 to 2290 (+242), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 2290 to 2250 (-40), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 2250 to 2266 (+16), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 2266 to 2274 (+8), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 2274 to 2264 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:36+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2264 to 2545 (+281), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:00+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2545 to 2546 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "a40ac22be3f549a195fe420d243c1c59e584f88c81e090203a9f8098b56ee6fc"
