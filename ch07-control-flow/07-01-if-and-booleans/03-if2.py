"""Purpose: examples/ch07-control-flow/07-01-if-and-booleans/03-if2.metta in Python: a symbol is not a variable.
...
#: RE-PINNED 2026-08-26, 6677 to 6761 (+84), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 6761 to 6781 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 6781 to 4194 (-2587), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 4194 to 4185 (-9), the subtract-atom primitive and the
...
#: RE-PINNED 2026-09-01, 4185 to 4203 (+18), generic Python operators now
...
#: RE-PINNED 2026-09-02, 4189 to 4252 (+63), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4252 to 4232 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 4232 to 4242 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 4242 to 4457 (+215), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 4457 to 4599 (+142), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 4599 to 4645 (+46), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 4645 to 4595 (-50), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 4595 to 4608 (+13), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 4595 to 4628 (+33), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 4628 to 4638 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 4638 to 4615 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 4608 to 4643 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 4643 to 4633 (-10), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 4633 to 4661 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 4615 to 4756 (+141), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 4756 to 4696 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 4696 to 4787 (+91), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 4615 to 4648 (+33), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 4648 to 4722 (+74), the compiled vocabulary seed, the
...
#: tree, -65 against the trunk's own pin of 4787 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +139 is what landed
...
#: RE-PINNED 2026-09-09, 4782 to 4792 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 4792 to 3550 (-1242), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 3550 to 3545 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 3545 to 3551 (+6), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 3551 to 3621 (+70), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 4095 to 4024 (-71), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 4024 to 4047 (+23), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 4047 to 4040 (-7), the registration refusal kind makes
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4335 to 4336 (+1), every force of a waiting function
