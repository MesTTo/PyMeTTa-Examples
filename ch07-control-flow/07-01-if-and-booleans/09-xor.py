"""Purpose: examples/ch07-control-flow/07-01-if-and-booleans/09-xor.metta in Python: `xor` inside an equation.
...
#: RE-PINNED 2026-08-26, 9108 to 9201 (+93), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 9201 to 9221 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 9221 to 4686 (-4535), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 4686 to 4675 (-11), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-06, 6224 to 6106 (-118), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 6106 to 6292 (+186), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 6292 to 6331 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 6331 to 6279 (-52), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 6279 to 6272 (-7), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 6272 to 6291 (+19), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 6272 to 6317 (+45), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 6317 to 6327 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 6327 to 6318 (-9), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 6291 to 6324 (+33), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 6324 to 6336 (+12), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 6336 to 6381 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 6318 to 6466 (+148), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 6466 to 6406 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 6406 to 6514 (+108), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 6318 to 6350 (+32), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 6350 to 6394 (+44), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 6394 to 6495 (+101), the compiled vocabulary seed, the
...
#: tree, -19 against the trunk's own pin of 6514 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +120 is what landed
...
#: RE-PINNED 2026-09-09, 6495 to 6555 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 6555 to 6565 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 6565 to 6560 (-5), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 6560 to 5475 (-1085), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 6560 to 5942 (-618), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 5942 to 5777 (-165), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 5777 to 5801 (+24), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 5801 to 5807 (+6), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 5807 to 5797 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:49+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 5797 to 5654 (-143), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:18+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 5654 to 5655 (+1), every force of a waiting function
...
DIVERGENCE = "2bdfbdb79b94f0345e9dcbdf571d8beeb05912b3d83c5f7fccf92f5e6517043c"
