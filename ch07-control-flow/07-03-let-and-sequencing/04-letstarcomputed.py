"""Purpose: examples/ch07-control-flow/07-03-let-and-sequencing/04-letstarcomputed.metta in Python: bindings as a value.
...
#: RE-PINNED 2026-08-26, 12889 to 12877 (-12), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 12877 to 11300 (-1577), by the specializer
...
#: RE-PINNED 2026-09-01, 11300 to 10732 (-568), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 10732 to 10704 (-28), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-02, 10704 to 10984 (+280), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 10984 to 11013 (+29), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 11013 to 11025 (+12), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 11025 to 10224 (-801), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 10224 to 10606 (+382), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 10606 to 10558 (-48), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 10558 to 10570 (+12), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 10578 to 10593 (+15), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 10593 to 10568 (-25), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 10568 to 10748 (+180), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 10748 to 10907 (+159), the compiled vocabulary seed,
...
#: tree, +153 against the trunk's own pin of 10754 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +6 is what landed
...
#: RE-PINNED 2026-09-11, 9621 to 9920 (+299), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 9621 to 9805 (+184), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 9805 to 9614 (-191), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 9614 to 9637 (+23), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 9637 to 9246 (-391), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:52+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 9246 to 9247 (+1), every force of a waiting function
