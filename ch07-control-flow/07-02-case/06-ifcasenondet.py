"""Purpose: examples/ch07-control-flow/07-02-case/06-ifcasenondet.metta in Python: a nondeterministic test.
...
Filed as residue against P14.4, the same gap ch06-many-answers/04-supercollapse.metta
records.
Guarantees:
...
#: RE-PINNED 2026-08-25, 12619 to 12659, at the flat-door
...
#: RE-PINNED 2026-08-25, 12659 to 12667, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 12667 to 12636, on the release tree:
...
#: RE-PINNED 2026-08-25, 12636 to 12641, at the release cut: the
...
#: RE-PINNED 2026-08-26, 12641 to 14274 (+1633), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 14274 to 14294 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 14294 to 12841 (-1453), by the specializer
...
#: RE-PINNED 2026-09-01, 12841 to 7633 (-5208), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 7633 to 7614 (-19), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 7614 to 7631 (+17), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 7631 to 7728 (+97), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 7728 to 7734 (+6), P43 protects both generated policy-
#: check fallbacks from space-local capture [measured 2026-09-02: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 7734 to 6885 (-849), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 6885 to 7081 (+196), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 7081 to 7121 (+40), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 7121 to 7041 (-80), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 7041 to 7034 (-7), the evaluation-fuel scope marker is
...
#: RE-PINNED 2026-09-08, 7034 to 7056 (+22), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 7034 to 7079 (+45), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 7079 to 7089 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 7056 to 7089 (+33), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 7089 to 7111 (+22), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 7111 to 7156 (+45), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 7089 to 7323 (+234), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 7323 to 7263 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 7263 to 7371 (+108), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 7089 to 7138 (+49), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 7138 to 7132 (-6), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 7132 to 7315 (+183), the compiled vocabulary seed, the
...
#: tree, -56 against the trunk's own pin of 7371 at da0e5755d; the previous
...
#: RE-PINNED 2026-09-09, 7315 to 7375 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 7375 to 7385 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 7385 to 7377 (-8), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 7377 to 6291 (-1086), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 7377 to 6720 (-657), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 6720 to 6652 (-68), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 6652 to 6695 (+43), the sixty libraries derived in
...
#: RE-PINNED 2026-09-25, 6695 to 6684 (-11), the registration refusal kind
...
#: the base [measured 2026-09-25T06:27:02+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 6684 to 6571 (-113), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:39+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 6571 to 6572 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "40fec36ef6bb4ce75687c01a3115c46fa07fd82fa348dbe3b37fe02d2fbae20b"
