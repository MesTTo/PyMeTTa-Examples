"""Purpose: examples/ch07-control-flow/07-02-case/01-case.metta in Python: the first matching branch.
...
#: RE-PINNED 2026-08-25, 4780 to 4790, at the release cut: the
...
#: RE-PINNED 2026-08-26, 4790 to 4808 (+18), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 4808 to 3154 (-1654), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3154 to 3147 (-7), the subtract-atom primitive and the
...
#: RE-PINNED 2026-09-02, 3147 to 3203 (+56), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3203 to 3183 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3183 to 3193 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3193 to 2693 (-500), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 2693 to 2761 (+68), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 2761 to 2799 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 2799 to 2760 (-39), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 2760 to 2775 (+15), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 2760 to 2765 (+5), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 2765 to 2775 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 2775 to 2752 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 2775 to 2812 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 2812 to 2772 (-40), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 2772 to 2800 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 2752 to 2887 (+135), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 2887 to 2827 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 2827 to 2920 (+93), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 2752 to 2799 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 2799 to 2869 (+70), the compiled vocabulary seed, the
...
#: tree, -51 against the trunk's own pin of 2920 at da0e5755d; the previous
...
#: RE-PINNED 2026-09-09, 2869 to 2929 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 2929 to 2939 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 2939 to 1702 (-1237), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 1702 to 1697 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 1697 to 1702 (+5), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 1702 to 1743 (+41), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 1702 to 1965 (+263), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 1965 to 1944 (-21), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 1944 to 1956 (+12), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 1956 to 1965 (+9), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 1965 to 1955 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:54+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 1955 to 2262 (+307), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:43:26+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2262 to 2263 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "4ee4270a54ffb2cc6119c4bcc2a53ab699abde0a7d9e1edb12e294811ed1f578"
