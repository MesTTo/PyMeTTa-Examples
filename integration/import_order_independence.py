...
Guarantees:
  - twin performs the import and checks its caller after the fixture's own
    claim succeeds [measured 2026-08-23: twin completed; command=python bindings/python/tools/twin_coverage.py examples/integration/import_order_independence.metta; fixture=fresh isolated process; commit=WORKTREE]
Open Obligations:
  To Do: None
  Hacks: None
