...
#: RE-PINNED 2026-09-02, 88452 to 88786 (+334), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 88786 to 88798 (+12), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 88798 to 88642 (-156), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 88642 to 88933 (+291), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 88933 to 88975 (+42), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 88975 to 88838 (-137), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 88832 to 88856 (+24), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 89201 to 89183 (-18), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 88909 to 89221 (+312), the door table landed
...
#: RE-PINNED 2026-09-08, 89183 to 104422 (+15239), Trailing occurrence
...
#: RE-PINNED 2026-09-08, 104422 to 104362 (-60), Sharing the fast-image
...
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 104362 to 104473 (+111), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 89183 to 89214 (+31), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 89214 to 89311 (+97), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 89311 to 104506 (+15195), the compiled vocabulary
...
#: merged tree, +33 against the trunk's own pin of 104473 at da0e5755d; the
#: previous number is the branch's cut-time price, and the remaining +15162 is
...
#: RE-PINNED 2026-09-09, 104506 to 104566 (+60), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 104566 to 104576 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 104576 to 102065 (-2511), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 102065 to 100635 (-1430), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 102065 to 101290 (-775), the branch's landings since
...
#: RE-PINNED 2026-09-18, 101290 to 101094 (-196), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 101094 to 101153 (+59), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 101153 to 101165 (+12), placed on the full-
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-24, 101165 to 91172 (-9993), +21 at 850d2a660, which reads
#: a native space's lengths in ascending arity rather than functor-hash order;
#: -10,014 at 0f6d29ba6, the seat's early-exit questions asked by key or in
...
#: RE-PINNED 2026-09-25, 91172 to 91157 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:30:58+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 91157 to 91423 (+266), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:53:09+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 91423 to 91424 (+1), every force of a waiting function
...
#: 88933 against a ceiling of 71191; a minimal twin of this example costs
#: 55063, inside the ceiling's 71191, so the distance is this twin's own
#: program [measured 2026-09-07: one fresh process per side; command=python
#: extensions/python/benchmarks/probes/twin_floor.py; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
#: OVERRUN 2026-09-08, 17800 to 17936 (+136): the module boundary merged with
...
#: crossing this twin makes pays it and the example pays none. Measured 89183
#: against a ceiling of 89047; a minimal twin costs 55077 against the band's
#: 71247, within that ceiling, so the rest is this twin's own program
...
#: OVERRUN 2026-09-09, 17936 to 17975 (+39): the door table landed
#: (feat/space-as-a-projection-of-door-rows merged at 6471faa37, its
#: reconciliation fixes at 58bf75947): every Space door is a generated alias
#: over its body, the catalog publishes the door contracts at boot as typed
#: atoms, and the seam's listeners publish on every registration, so boot
#: content and clause layout moved; every crossing this twin makes pays it and
#: the example pays none. Measured 89221 against a ceiling of 89182; a minimal
#: twin costs 55075 against the band's 71246, within that ceiling, so the rest
...
#: the twin holds 3 the example does not (1 :, 1 =, 1 @doc): the twin is an
...
DIVERGENCE = "39e7838a40d042bb2e8d5f6ad826815580c15163cf960abdce6c8bb6b56bf51a"
