"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/04-memo_same_name_multi_arity.metta in Python: two arities, cached apart.
...
#: RE-PINNED 2026-08-26, 37353 to 37015 (-338), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 37015 to 37035 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 37035 to 41476 (+4441), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 41476 to 41454 (-22), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 41501 to 42010 (+509), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 42010 to 41990 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 41990 to 42000 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 42000 to 40426 (-1574), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 40426 to 44668 (+4242), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 44668 to 44707 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 44707 to 44652 (-55), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 44652 to 44634 (-18), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 44634 to 44654 (+20), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 44634 to 44675 (+41), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 44675 to 44685 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 44685 to 44789 (+104), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 44654 to 44689 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 44689 to 44809 (+120), the door table landed
...
#: RE-PINNED 2026-09-09, 44809 to 44990 (+181), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 44789 to 46248 (+1459), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 46248 to 46188 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 46188 to 46434 (+246), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 44789 to 44836 (+47), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 44836 to 44871 (+35), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 44871 to 46421 (+1550), the compiled vocabulary seed,
...
#: tree, -13 against the trunk's own pin of 46434 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1563 is what
...
#: RE-PINNED 2026-09-09, 46421 to 32795 (-13626), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 32795 to 32805 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 32805 to 32799 (-6), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 32799 to 31730 (-1069), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 32799 to 33438 (+639), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 33438 to 32988 (-450), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 32988 to 33217 (+229), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 33217 to 40644 (+7427), placed on the full-
...
#: RE-PINNED 2026-09-24, 40644 to 40387 (-257), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-188); gate-perf's
...
#: RE-PINNED 2026-09-25, 40387 to 40372 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:05+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 40372 to 36015 (-4357), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:56:21+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 36015 to 36024 (+9), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 36024 to 36037 (+13), the erase audit routes three
...
#: 2026-09-25T20:43:41+10:00: min-of-3 serial fresh processes; command=python
