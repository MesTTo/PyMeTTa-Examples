"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/02-memo_aggregate.metta in Python: the one claim Python cannot make.
...
#: RE-PINNED 2026-09-02, 38069 to 39227 (+1158), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 39227 to 39191 (-36), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 39191 to 39230 (+39), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 39230 to 34338 (-4892), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 34338 to 38697 (+4359), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 38697 to 38724 (+27), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 38724 to 38659 (-65), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 38659 to 38672 (+13), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 38659 to 38692 (+33), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 38692 to 38702 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 38702 to 38754 (+52), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 38672 to 38707 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 38707 to 38774 (+67), the door table landed
...
#: RE-PINNED 2026-09-09, 38774 to 38887 (+113), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 38754 to 40186 (+1432), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 40186 to 40126 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 40126 to 40304 (+178), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 38754 to 38775 (+21), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 38775 to 38766 (-9), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 38766 to 40221 (+1455), the compiled vocabulary seed,
...
#: tree, -83 against the trunk's own pin of 40304 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1538 is what
...
#: RE-PINNED 2026-09-09, 40221 to 26595 (-13626), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 26595 to 26605 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-11, 26598 to 25691 (-907), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 26598 to 27409 (+811), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 27409 to 26943 (-466), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 26943 to 27176 (+233), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 27176 to 34603 (+7427), placed on the full-
...
#: RE-PINNED 2026-09-24, 34603 to 34414 (-189), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-120); gate-perf's
...
#: RE-PINNED 2026-09-25, 34414 to 34399 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:00+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 34399 to 34354 (-45), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:56:15+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 34354 to 34363 (+9), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 34363 to 34374 (+11), the erase audit routes three
...
#: example -13659, and the twin sat 186 within its ceiling there. Measured
#: 26605 against a ceiling of 26606; a minimal twin costs 21942 against the
#: band's 25517, within that ceiling, so the rest is this twin's own program
...
#: RE-PRICED 2026-09-11, 1089 to 1244 (+155): the band stopped granting the
...
#: twin still pays 155 of it: the first use of the lowering paths its 1
#: definition take, which the fixture's `return x + 1` does not exercise.
#: Measured 25691 against a ceiling of 25536 (20711 times 1.1 plus 303 once
#: plus 1 times 1362 plus the declared 1089) [measured 2026-09-11: sh check.sh
...
#: RE-PRICED 2026-09-11, 1244 to 1245 (+1): engine/metta/limits.pl's wrappers,
#: installed at boot, cost this example and this twin 2 inferences fewer each
#: (20711 to 20709, 25691 to 25689), and the band scales the example's move by
#: 1.1 while the twin moves by 1, so a residual pinned 0.1 inside its ceiling
...
DIVERGENCE = "52ebefb7fddd130d89220fd0f3dd7c4f178b3ad27bb9708c63a7c91da6d91a9e"
