"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/09-tabling_fib.metta in Python: tabled recursion, declared once.
...
#: RE-PINNED 2026-09-01, 96272 to 83752 (-12520), one corpus pricing pass on
...
#: RE-PINNED 2026-09-01, 83752 to 83720 (-32), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 83720 to 84486 (+766), generic Python operators now
...
#: RE-PINNED 2026-09-02, 89553 to 90338 (+785), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 90338 to 90450 (+112), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 90450 to 90420 (-30), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 90420 to 90867 (+447), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 90867 to 151467 (+60600), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 151467 to 151417 (-50), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 151417 to 151334 (-83), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 151334 to 149643 (-1691), the evaluation-fuel scope
...
#: RE-PINNED 2026-09-08, 149643 to 149677 (+34), boot content moved: the
...
#: RE-PINNED 2026-09-08, 149643 to 158207 (+8564), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 158207 to 158227 (+20), The engine and library module
...
#: RE-PINNED 2026-09-08, 158227 to 158185 (-42), the module boundary merged
...
#: RE-PINNED 2026-09-08, 149677 to 149967 (+290), The typed host door catalog
...
#: RE-PINNED 2026-09-09, 149967 to 158505 (+8538), the door table landed
...
#: RE-PINNED 2026-09-09, 158505 to 158570 (+65), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 158185 to 161804 (+3619), Trailing occurrence
...
#: RE-PINNED 2026-09-08, 161804 to 161744 (-60), Sharing the fast-image
...
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 161744 to 162129 (+385), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 158185 to 158219 (+34), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 158219 to 158211 (-8), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 158211 to 161995 (+3784), the compiled vocabulary
...
#: merged tree, -134 against the trunk's own pin of 162129 at da0e5755d; the
#: previous number is the branch's cut-time price, and the remaining +3918 is
...
#: RE-PINNED 2026-09-09, 161995 to 50837 (-111158), a library's Prolog half
...
#: RE-PINNED 2026-09-11, 50830 to 50410 (-420), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 50830 to 52550 (+1720), the branch's landings since
...
#: RE-PINNED 2026-09-18, 52550 to 51809 (-741), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 51809 to 169853 (+118044), the sixty libraries derived
...
#: RE-PINNED 2026-09-24, 169853 to 183208 (+13355), placed on the full-
...
#: RE-PINNED 2026-09-24, 78647 to 79197 (+550), +551 at 850d2a660, which reads
...
#: RE-PINNED 2026-09-24, 78731 to 78723 (-8), the host switch of
...
#: RE-PINNED 2026-09-25, 78723 to 78621 (-102), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:18+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 78621 to 78431 (-190), the host evaluation door
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 78466 to 78475 (+9), the erase audit routes three
...
#: twin still pays 1 of it: the first use of the lowering paths its 1
#: definition take, which the fixture's `return x + 1` does not exercise.
#: Measured 50410 against a ceiling of 50409 (40462 times 1.1 plus 303 once
