"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/01-memo_multi_answer.metta in Python: caching a function that answers twice.
...
#: RE-PINNED 2026-08-26, 36439 to 36459 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-09-01, 36459 to 34488 (-1971), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 34488 to 34469 (-19), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 34469 to 34481 (+12), generic Python operators now
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 34870 to 31493 (-3377), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 31493 to 35582 (+4089), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 35582 to 35621 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 35621 to 35577 (-44), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 35577 to 35599 (+22), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 35577 to 35562 (-15), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 35562 to 35572 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 35572 to 35579 (+7), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 35599 to 35634 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 35634 to 35599 (-35), the door table landed
...
#: RE-PINNED 2026-09-09, 35599 to 35661 (+62), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 35579 to 36861 (+1282), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 36861 to 36801 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 36801 to 36928 (+127), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 35579 to 35626 (+47), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 35626 to 35619 (-7), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 35619 to 36873 (+1254), the compiled vocabulary seed,
...
#: tree, -55 against the trunk's own pin of 36928 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1309 is what
...
#: RE-PINNED 2026-09-09, 36873 to 23247 (-13626), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 23247 to 23257 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 23257 to 23252 (-5), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 23252 to 22228 (-1024), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 23252 to 23390 (+138), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 23390 to 23179 (-211), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 23179 to 23394 (+215), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 23394 to 30825 (+7431), placed on the full-
...
#: RE-PINNED 2026-09-24, 30825 to 30632 (-193), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-124); gate-perf's
...
#: RE-PINNED 2026-09-25, 30632 to 30617 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:33:58+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 30617 to 30773 (+156), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:56:12+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 30773 to 30782 (+9), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 30782 to 30791 (+9), the erase audit routes three
