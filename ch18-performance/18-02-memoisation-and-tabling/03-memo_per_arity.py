"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/03-memo_per_arity.metta in Python: memoizing one arity of a name.
...
#: RE-PINNED 2026-09-01, 36853 to 36839 (-14), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 36916 to 36868 (-48), exact numeric annotations retain
...
#: RE-PINNED 2026-09-02, 36868 to 37292 (+424), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 37292 to 37272 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 37272 to 37282 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 37282 to 37994 (+712), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 37994 to 42187 (+4193), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 42187 to 42224 (+37), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 42224 to 42153 (-71), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 42153 to 42147 (-6), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 42147 to 42167 (+20), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 42147 to 42176 (+29), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 42176 to 42186 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 42186 to 42234 (+48), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 42167 to 42202 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 42202 to 42254 (+52), the door table landed
...
#: RE-PINNED 2026-09-09, 42254 to 42367 (+113), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 42234 to 43522 (+1288), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 43522 to 43462 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 43462 to 43640 (+178), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 42234 to 42281 (+47), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 42281 to 42421 (+140), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 42421 to 43732 (+1311), the compiled vocabulary seed,
...
#: tree, +92 against the trunk's own pin of 43640 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1219 is what
...
#: RE-PINNED 2026-09-09, 43732 to 30106 (-13626), a library's Prolog half
...
#: RE-PINNED 2026-09-11, 30110 to 29029 (-1081), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 30110 to 30619 (+509), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 30619 to 30276 (-343), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 30276 to 30505 (+229), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 30505 to 37932 (+7427), placed on the full-
...
#: RE-PINNED 2026-09-24, 37932 to 37747 (-185), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-116); gate-perf's
...
#: RE-PINNED 2026-09-25, 37747 to 37732 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:03+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 37732 to 38204 (+472), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:56:18+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 38204 to 38213 (+9), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 38213 to 38222 (+9), the erase audit routes three
...
#: against a ceiling of 41655; a minimal twin of this example costs 34127,
#: inside the ceiling's 41655, so the distance is this twin's own program
...
#: OVERRUN 2026-09-09, 600 to 895 (+295): the compiled vocabulary seed, the
...
#: trunk's own run at da0e5755d the twin moved +92 and the example +8, and the
#: twin sat 211 over its ceiling there already. Measured 43732 against a
#: ceiling of 43438; a minimal twin costs 35433 against the band's 42838,
...
#: OVERRUN 2026-09-09, 895 to 2110 (+1215): a library's Prolog half compiles
