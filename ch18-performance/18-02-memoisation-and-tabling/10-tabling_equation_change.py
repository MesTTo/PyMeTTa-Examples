"""Purpose: examples/ch18-performance/18-02-memoisation-and-tabling/10-tabling_equation_change.metta in Python: a table goes stale, and knows.
...
#: RE-PINNED 2026-08-26, 54057 to 51014 (-3043), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 51014 to 51104 (+90), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 51104 to 61796 (+10692), at the
...
#: RE-PINNED 2026-08-26, 61796 to 60357 (-1439), by the specializer
...
#: RE-PINNED 2026-09-01, 60357 to 66213 (+5856), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 66213 to 66227 (+14), the compiled-language batch:
...
#: extensions/python/tools/twin_coverage.py --repin; commit=51b792423cec5787614d1488c0793b8a50eaa6fc].
#: RE-PINNED 2026-09-01, 66227 to 66164 (-63), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 66164 to 66188 (+24), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 66188 to 66541 (+353), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 66541 to 66501 (-40), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 66501 to 66491 (-10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 66491 to 66060 (-431), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 66060 to 126325 (+60265), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 126325 to 126347 (+22), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 126347 to 126312 (-35), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 126312 to 126301 (-11), the evaluation-fuel scope
...
#: RE-PINNED 2026-09-08, 126301 to 126366 (+65), boot content moved: the
...
#: RE-PINNED 2026-09-08, 126301 to 134755 (+8454), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 134755 to 134795 (+40), The engine and library module
...
#: RE-PINNED 2026-09-08, 134795 to 134715 (-80), the module boundary merged
...
#: RE-PINNED 2026-09-08, 126366 to 126662 (+296), The typed host door catalog
...
#: RE-PINNED 2026-09-09, 126662 to 135011 (+8349), the door table landed
...
#: RE-PINNED 2026-09-09, 135011 to 135147 (+136), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 134715 to 138340 (+3625), Trailing occurrence
...
#: RE-PINNED 2026-09-08, 138340 to 138160 (-180), Sharing the fast-image
...
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 138160 to 138682 (+522), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 134715 to 134883 (+168), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 134883 to 134875 (-8), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 134875 to 138491 (+3616), the compiled vocabulary
...
#: merged tree, -191 against the trunk's own pin of 138682 at da0e5755d; the
#: previous number is the branch's cut-time price, and the remaining +3807 is
...
#: RE-PINNED 2026-09-09, 138491 to 27453 (-111038), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 27453 to 27473 (+20), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 27473 to 27413 (-60), Receipt cleanup stops at the
...
#: RE-PINNED 2026-09-10, 27413 to 27395 (-18), The receipt crash repair
...
#: command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=8ca8a387fc61d0918484b19a1a3baf85b6523043].
#: RE-PINNED 2026-09-11, 27395 to 26592 (-803), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 27395 to 28149 (+754), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 28149 to 28169 (+20), 49478d67a landed the polynomial
...
#: RE-PINNED 2026-09-18, 28169 to 28052 (-117), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-19, 28052 to 28042 (-10), cost follows the answer: a block
...
#: ENVELOPED 2026-09-19: the point 28042 becomes the envelope 27952..28042 over
#: 11: under the lane's own protocol (full-lane/294/workers=32, ten rounds) the
#: counter reads 28042 every time, and under the gate's concurrent lanes (one
#: run, below the point) it reads 27952, each reading exact on its run; the
#: extra mode is the same program's work done on a different thread under load,
#: a loader flight or a settle step the foreground runs itself when the worker
#: is late, which the join accounting does not reach; an envelope states what
#: was observed and the point was a lie under the gate [measured 2026-09-19:
#: the twins lane alone on the final tree and under the gate's concurrent
#: lanes, wt-battery-2 ai-full-gate-10da82e4a.log, ai-full-gate-19fdb0b86.log,
#: ai-lanes-exports-back.log; commit=1ccbb142315d16a719807cd2c9754e4a2fcefdf1].
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 27952..28042 to 145926..145926 over
...
#: RE-OBSERVED 2026-09-21 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 145926..145926 to 145926..145926 over
...
#: time=9223372036854775807/before-boot', 145926..145926 to 152274..152274 over
...
#: time=9223372036854775807/before-boot', 152274..152274 over 20 to
#: 152274..152274 over 28: the 8 whole-lane runs of this runtime the envelope
#: did not yet hold read the pin run's first lane 152274; the pin run's second
#: lane 152274; the pin run's third lane 152274; the first final lane 152274;
#: the purged lane on 49e2b250d 152274; the purged lane on 26de4ddcf 152274;
#: the purged lane after a8487162 152274; the purged lane after 878b8bd9
#: 152274. They are the pin run's own lanes on the 6a7ac233d snapshot and the
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 152274..152274 to 47623..47623 over
...
#: RE-OBSERVED 2026-09-24 under 'full-lane/323/workers=32/file-search-cache-
#: time=9223372036854775807/before-boot', 47673..47673 to 47983..47983 over 21
...
#: went from 47,773 to 47,983 (at d832d20e8 the serial protocol read 100 over
#: the full lane's 47,673..47,673, and on the fixed tree the two agree, so that
#: difference is part of the band's move and falls on no rung); 4890e870d gives
#: the governed QLF set one producer (-110); provider-carry's 850d2a660 reads a
#: native space's lengths in ascending order (+573); d4a365c16 holds the
#: support graph's visited set and the reference refresh's space sets in tries
#: instead of library(nb_set) (-156); gate-perf's d781eab8f copies a withdrawn
#: equation once (-96); one other rung moved it -1; an empirical envelope is a
#: claim about one scheduler's protocol on one tree, so these observations are
#: this tree's own and are not pooled with the earlier ones [measured
#: 2026-09-24: 21 full-lane observations on the fixed tree, the twenty rounds
