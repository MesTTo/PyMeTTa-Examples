...
def twin(m):
    ...
    # Exactness reaches across KINDS as well as across numeric species: a
    # number is not a string, and the SYMBOL `true` is not the number 1.
    # !(test (== 1 "s") False) and !(test (== true 1) False)
    assert equal(1, G("s")) == [False]
    assert equal(S.true, 1) == [False]
...
#: RE-PINNED 2026-09-01, 9845 to 9968 (+123), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 9968 to 10147 (+179), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 10147 to 10140 (-7), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 10140 to 10150 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 10150 to 10079 (-71), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 10079 to 10432 (+353), trunk's own movement since each
...
#: RE-PINNED 2026-09-07, 10432 to 10777 (+345), the twin gained the claims of
...
#: RE-PINNED 2026-09-08, 10777 to 10815 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 10815 to 10807 (-8), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 10807 to 10727 (-80), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 10727 to 10744 (+17), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 10727 to 10926 (+199), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 10926 to 10936 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 10936 to 11263 (+327), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 10744 to 10781 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 10781 to 11283 (+502), the door table landed
...
#: RE-PINNED 2026-09-09, 11283 to 11736 (+453), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 11263 to 11416 (+153), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 11416 to 11356 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 11356 to 11874 (+518), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 11263 to 11287 (+24), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 11287 to 11803 (+516), the compiled vocabulary seed,
...
#: tree, -71 against the trunk's own pin of 11874 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +587 is what landed
...
#: RE-PINNED 2026-09-09, 11803 to 11863 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 11863 to 11873 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 11873 to 10137 (-1736), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 10137 to 10132 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 10132 to 10137 (+5), automatic memo reconciliation
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 10137 to 10270 (+133), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 10137 to 10598 (+461), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 10598 to 10487 (-111), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 10487 to 10495 (+8), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 10495 to 10505 (+10), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 10505 to 10495 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:26:08+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 10495 to 16968 (+6473), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:41:38+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 16968 to 16969 (+1), every force of a waiting function
