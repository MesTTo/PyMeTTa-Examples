"""Purpose: examples/ch05-equations-and-evaluation/05-02-changing-the-equations/03-functionremovalspec.metta in Python: removal under specialization.
...
#: RE-PINNED 2026-08-25, 19598 to 19608, at the release cut: the
...
#: RE-PINNED 2026-08-26, 19608 to 21337 (+1729), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 21337 to 21359 (+22), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 21359 to 19873 (-1486), by the specializer
...
#: RE-PINNED 2026-09-01, 19873 to 12531 (-7342), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 12531 to 12583 (+52), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 12583 to 12505 (-78), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 14014 to 14557 (+543), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 14557 to 14588 (+31), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 14588 to 14598 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 14598 to 13669 (-929), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 13669 to 13881 (+212), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 13881 to 13924 (+43), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 13924 to 13848 (-76), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 13848 to 13866 (+18), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 13848 to 13854 (+6), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 13854 to 13864 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 13864 to 13831 (-33), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 13866 to 13901 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 13901 to 13851 (-50), the door table landed
...
#: RE-PINNED 2026-09-09, 13851 to 13861 (+10), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 13831 to 14855 (+1024), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 14855 to 14795 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 14795 to 14870 (+75), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 13831 to 13857 (+26), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 13857 to 13842 (-15), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 13842 to 14785 (+943), the compiled vocabulary seed,
...
#: tree, -85 against the trunk's own pin of 14870 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1028 is what
...
#: RE-PINNED 2026-09-09, 14785 to 14845 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 14845 to 14855 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 14855 to 14749 (-106), Receipt cleanup stops at the
...
#: RE-PINNED 2026-09-10, 14749 to 14717 (-32), The receipt crash repair
...
#: command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=8ca8a387fc61d0918484b19a1a3baf85b6523043].
#: RE-PINNED 2026-09-11, 14717 to 13682 (-1035), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 14717 to 14697 (-20), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 14697 to 14372 (-325), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 14372 to 14447 (+75), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 14447 to 14456 (+9), placed on the full-configuration
...
#: and lib_random to green; da91bc244 confines an exact removal's selection to
#: its own atom: native_retract_one/2 now records the selected clause's head, a
...
#: +24 to +192 on the library twins that withdraw package rows) [measured
#: 2026-09-24: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=WORKTREE].
#: RE-PINNED 2026-09-24, 14456 to 13976 (-480), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-476); gate-perf's
...
#: RE-PINNED 2026-09-25, 13976 to 13966 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:25:58+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 13966 to 13825 (-141), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:41:18+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 13825 to 13845 (+20), both specializer doors prepare a
...
#: RE-PINNED 2026-09-25, 13845 to 13846 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 13846 to 13880 (+34), lambdas are named by their
...
#: RE-PINNED 2026-09-25, 13880 to 13891 (+11), the erase audit routes three
...
#: 2026-09-25T20:40:33+10:00: min-of-3 serial fresh processes; command=python
...
DIVERGENCE = "7f42adbe88bdf90fdf2da12eb84aaefb1ac4b680b5128bc292b6d756c1062db2"
