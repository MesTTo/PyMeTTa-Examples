"""Purpose: examples/ch05-equations-and-evaluation/05-02-changing-the-equations/02-functionremoval.metta in Python: equations move.
...
for the reason examples/ch05-equations-and-evaluation/05-02-changing-the-equations/01-dispatch_policies.metta's twin measures:
...
#: RE-PINNED 2026-09-01, 15923 to 12448 (-3475), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 12448 to 12612 (+164), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 12612 to 12404 (-208), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 13115 to 13551 (+436), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 13551 to 13561 (+10), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 13561 to 13571 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 13571 to 12110 (-1461), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 12110 to 12312 (+202), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 12312 to 12355 (+43), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 12355 to 12301 (-54), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 12301 to 12319 (+18), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 12301 to 12310 (+9), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 12310 to 12320 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 12320 to 12287 (-33), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 12319 to 12354 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 12354 to 12307 (-47), the door table landed
...
#: RE-PINNED 2026-09-09, 12307 to 12317 (+10), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 12287 to 13718 (+1431), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 13718 to 13658 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 13658 to 13733 (+75), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 12287 to 12327 (+40), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 12327 to 12310 (-17), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 12310 to 13661 (+1351), the compiled vocabulary seed,
...
#: tree, -72 against the trunk's own pin of 13733 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1423 is what
...
#: RE-PINNED 2026-09-09, 13661 to 13721 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 13721 to 13731 (+10), engine/qlf_boot.pl gained the
...
#: command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=8ca8a387fc61d0918484b19a1a3baf85b6523043].
#: RE-PINNED 2026-09-11, 13485 to 12492 (-993), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 13485 to 13463 (-22), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 13463 to 13242 (-221), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 13242 to 13319 (+77), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 13319 to 13341 (+22), placed on the full-configuration
...
#: dropped; da91bc244 confines an exact removal's selection to its own atom:
...
#: RE-PINNED 2026-09-25, 12798 to 12788 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:25:55+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 12788 to 12645 (-143), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:41:15+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 12645 to 12658 (+13), both specializer doors prepare a
...
#: RE-PINNED 2026-09-25, 12658 to 12659 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 12659 to 12691 (+32), lambdas are named by their
...
#: RE-PINNED 2026-09-25, 12691 to 12714 (+23), the erase audit routes three
...
#: 2026-09-25T20:40:30+10:00: min-of-3 serial fresh processes; command=python
