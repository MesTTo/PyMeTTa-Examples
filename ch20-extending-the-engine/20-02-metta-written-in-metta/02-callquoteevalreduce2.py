...
#: RE-PINNED 2026-09-01, 38665 to 38620 (-45), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 43783 to 44235 (+452), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 44235 to 44357 (+122), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 44357 to 44367 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 44367 to 43022 (-1345), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 43022 to 43396 (+374), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 43396 to 43491 (+95), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 43491 to 43308 (-183), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 43308 to 43297 (-11), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 43297 to 43338 (+41), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 43297 to 43383 (+86), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 43383 to 43393 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 43393 to 43436 (+43), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 43338 to 43392 (+54), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 43392 to 43476 (+84), the door table landed
...
#: RE-PINNED 2026-09-09, 43476 to 43555 (+79), structured concurrency landed
...
#: RE-PINNED 2026-09-09, 44050 to 44214 (+164), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 43436 to 43451 (+15), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 43451 to 43445 (-6), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 43445 to 44128 (+683), the compiled vocabulary seed,
...
#: tree, -86 against the trunk's own pin of 44214 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +769 is what landed
...
#: RE-PINNED 2026-09-09, 44128 to 44188 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 44188 to 44198 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 44198 to 44164 (-34), Public add-atom calls
...
#: RE-PINNED 2026-09-18, 44164 to 45856 (+1692), the branch's landings since
...
#: RE-PINNED 2026-09-18, 45856 to 45314 (-542), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 45314 to 45431 (+117), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 45431 to 48905 (+3474), placed on the full-
...
#: RE-PINNED 2026-09-25, 48714 to 48699 (-15), the registration refusal kind
...
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 48688 to 48689 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 48689 to 48694 (+5), the erase audit routes three
...
#: statements in this file, 1372 under BUDGET (the chain above it prices it on
#: 2026-09-11) and the other branch's 1705 below DIVERGENCE, documented by the
#: OVERRUN 2026-09-18 paragraph now above this one; the lane reads the first a
#: twin assigns and Python binds the last, so 1705 stopped being in force at
#: the merge and its statement is removed [source:
