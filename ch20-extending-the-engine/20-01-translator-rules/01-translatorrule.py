"""Purpose: examples/ch20-extending-the-engine/20-01-translator-rules/01-translatorrule.metta in Python: when the cons happens.
...
#: RE-PINNED 2026-08-25, 10218 to 10223, at the release cut: the
...
#: RE-PINNED 2026-08-26, 10223 to 11902 (+1679), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 11902 to 11922 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 11922 to 10482 (-1440), by the specializer
...
#: RE-PINNED 2026-09-01, 10482 to 7076 (-3406), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 7076 to 7057 (-19), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 7057 to 7085 (+28), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 7085 to 7274 (+189), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 7274 to 7262 (-12), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 7262 to 7272 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 7272 to 7213 (-59), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 7213 to 7451 (+238), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 7451 to 7493 (+42), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 7493 to 7423 (-70), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 7423 to 7408 (-15), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 7408 to 7431 (+23), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 7408 to 7461 (+53), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 7461 to 7471 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 7471 to 7510 (+39), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 7431 to 7468 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 7468 to 7530 (+62), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 7530 to 7626 (+96), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 7510 to 7811 (+301), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 7811 to 7751 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 7751 to 7912 (+161), tokens as storage landed
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 7556 to 7863 (+307), the compiled vocabulary seed, the
...
#: tree, -49 against the trunk's own pin of 7912 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +356 is what landed
...
#: RE-PINNED 2026-09-09, 7863 to 7923 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 7923 to 7933 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 7933 to 7921 (-12), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 7921 to 6892 (-1029), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 7921 to 7600 (-321), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 7600 to 7516 (-84), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 7516 to 7524 (+8), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 7524 to 7601 (+77), placed on the full-configuration
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 7601 to 7591 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:41+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 7591 to 7363 (-228), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:57:18+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 7363 to 7364 (+1), every force of a waiting function
