"""Purpose: examples/ch20-extending-the-engine/20-01-translator-rules/04-translatorrule_cost.metta in Python: cost, and a joined head.
...
#: [measured: twin minimum 11521 inferences; command=python
...
#: RE-PINNED 2026-09-02, 11521 to 12077 (+556), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 12077 to 12057 (-20), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 12057 to 12067 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 12067 to 12369 (+302), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 12369 to 12647 (+278), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 12647 to 12686 (+39), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 12584 to 12567 (-17), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 12567 to 12584 (+17), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 12567 to 12760 (+193), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 12760 to 12770 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 12770 to 12841 (+71), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 12584 to 12621 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 12621 to 12861 (+240), the door table landed
...
#: RE-PINNED 2026-09-09, 12861 to 13016 (+155), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 12841 to 13333 (+492), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 13333 to 13273 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 13273 to 13493 (+220), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 12841 to 12876 (+35), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 12876 to 12902 (+26), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 12902 to 13459 (+557), the compiled vocabulary seed,
...
#: tree, -34 against the trunk's own pin of 13493 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +591 is what landed
...
#: RE-PINNED 2026-09-09, 13459 to 13519 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 13519 to 13529 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 13529 to 13519 (-10), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 13519 to 12422 (-1097), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 13519 to 13482 (-37), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 13482 to 13233 (-249), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 13233 to 10912 (-2321), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 10912 to 10990 (+78), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 10990 to 10980 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:34:46+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 10980 to 10646 (-334), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:57:25+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 10646 to 10647 (+1), every force of a waiting function
