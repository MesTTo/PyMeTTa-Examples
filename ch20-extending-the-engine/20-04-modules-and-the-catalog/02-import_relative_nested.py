"""Purpose: examples/ch20-extending-the-engine/20-04-modules-and-the-catalog/02-import_relative_nested.metta in Python: one import, two files deep.
...
#: RE-PINNED 2026-09-01, 7285 to 7669 (+384), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 7669 to 7663 (-6), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 7663 to 7677 (+14), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 7677 to 7814 (+137), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 7814 to 7976 (+162), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 7976 to 8016 (+40), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 8016 to 8036 (+20), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 8036 to 8070 (+34), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 8070 to 8115 (+45), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 8115 to 8167 (+52), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 8115 to 8222 (+107), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 8222 to 8274 (+52), tokens as storage landed
...
#: RE-PINNED 2026-09-10, 8274 to 8231 (-43), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 8231 to 8238 (+7), automatic memo reconciliation uses
...
#: RE-PINNED 2026-09-11, 8238 to 8194 (-44), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 8238 to 8511 (+273), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 8511 to 8539 (+28), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 8539 to 8871 (+332), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 8871 to 8963 (+92), placed on the full-configuration
...
#: commit=WORKTREE].
#: RE-PINNED 2026-09-25, 8963 to 9879 (+916), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:58:29+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 9879 to 9895 (+16), every force of a waiting function
