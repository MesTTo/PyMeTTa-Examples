...
#: the base [measured 2026-09-25T06:38:26+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
...
#: OVERRUN 2026-09-24, 261 to 300 (+39): the band is the example's cost plus
...
#: example -390 and the twin -390, the excess +39.0. Measured 38705 against the
#: example's 33144, a band and authoring ceiling of 38405.4 (1947 to author 1
#: compiled definition); the floor probe's control costs 32853 [measured
...
#: extensions/python/benchmarks/probes/twin_floor.py examples/ch22-a-reasoner-
#: you-can-serve/22-03-search/05-fibadd.metta; commit=4ff69551e0e226442cf7257b96af858adda957a4].
OVERRUN = 300
