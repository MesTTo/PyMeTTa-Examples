"""Purpose: examples/ch22-a-reasoner-you-can-serve/22-01-logic-programs/01-logicprog.metta in Python: a recursive relation over facts.
...
#: RE-PINNED 2026-09-01, 17446 to 8357 (-9089), one corpus pricing pass on the
...
#: RE-PINNED 2026-09-01, 8357 to 8349 (-8), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-02, 8349 to 8720 (+371), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 8720 to 8703 (-17), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 8703 to 8684 (-19), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 8684 to 8339 (-345), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 8339 to 8567 (+228), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 8567 to 8419 (-148), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 8419 to 8436 (+17), The engine and library predicates
...
#: RE-PINNED 2026-09-09, 8436 to 8461 (+25), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 8436 to 8835 (+399), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 8835 to 8857 (+22), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 8436 to 8444 (+8), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 8444 to 8577 (+133), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 8577 to 8995 (+418), the compiled vocabulary seed, the
...
#: tree, +138 against the trunk's own pin of 8857 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +280 is what landed
...
#: RE-PINNED 2026-09-09, 8995 to 8985 (-10), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 8985 to 9012 (+27), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 8985 to 8790 (-195), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 8790 to 8664 (-126), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 8664 to 8756 (+92), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 8756 to 8626 (-130), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-130); each step read
...
#: RE-PINNED 2026-09-25, 8626 to 8627 (+1), every force of a waiting function
#: names the module it is made from, through fun_home_in/3, and a write forces
#: only its own space; the lanes' tree read this twin -3 off its pin before the
