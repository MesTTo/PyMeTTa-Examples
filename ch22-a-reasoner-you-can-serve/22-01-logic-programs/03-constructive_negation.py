"""Purpose: examples/ch22-a-reasoner-you-can-serve/22-01-logic-programs/03-constructive_negation.metta in Python: negation that answers.
...
#: RE-PINNED 2026-08-26, 130763 to 130442 (-321), on the composed
...
#: RE-PINNED 2026-09-01, 128989 to 90182 (-38807), one corpus pricing pass on
...
#: RE-PINNED 2026-09-01, 90182 to 90176 (-6), the compiled-language batch:
...
#: extensions/python/tools/twin_coverage.py --repin; commit=51b792423cec5787614d1488c0793b8a50eaa6fc].
#: RE-PINNED 2026-09-01, 90176 to 90039 (-137), the subtract-atom primitive and
...
#: RE-PINNED 2026-09-02, 90176 to 92344 (+2168), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 92344 to 92254 (-90), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 92254 to 92349 (+95), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 92349 to 86446 (-5903), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 86446 to 87650 (+1204), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 87650 to 87717 (+67), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 87717 to 87060 (-657), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 87060 to 86981 (-79), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 86981 to 87018 (+37), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 86981 to 87192 (+211), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 87192 to 87202 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 87202 to 87548 (+346), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 87018 to 87069 (+51), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 87069 to 87586 (+517), the door table landed
...
#: RE-PINNED 2026-09-09, 87586 to 88086 (+500), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 87548 to 89856 (+2308), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 89856 to 89796 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 89796 to 90379 (+583), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 87548 to 87633 (+85), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 87633 to 87676 (+43), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 87676 to 90412 (+2736), the compiled vocabulary seed,
...
#: tree, +33 against the trunk's own pin of 90379 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +2703 is what
...
#: RE-PINNED 2026-09-09, 90412 to 90472 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 90472 to 90482 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 90482 to 90424 (-58), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 90424 to 90049 (-375), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 90424 to 89981 (-443), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 89981 to 88531 (-1450), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 88531 to 88953 (+422), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 88953 to 88920 (-33), placed on the full-configuration
...
#: RE-PINNED 2026-09-24, 88920 to 88673 (-247), d4a365c16 holds the support
...
#: two pays a few inferences more for the trie's setup (-247); each step read
...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 88658 to 89660 (+1002), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:59:17+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 89660 to 89661 (+1), every force of a waiting function
