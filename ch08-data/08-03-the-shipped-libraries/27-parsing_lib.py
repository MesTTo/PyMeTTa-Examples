...
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 4685251 to 4685263 (+12), retiring a library importer
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 4685263 to 4685273 (+10),
#: lib/lib_string/lib_string.qlf is now compiled by a child of its own
#: whichever half's load reaches it first (engine/qlf_boot.pl,
#: qlf_compile_argument/0), and that compile keeps the :- non_terminal
#: directive for word_tokens//1 that a compile inside lib_csv's child, where
#: the warm-up's glob order put it, left out, since SWI's non_terminal_decl/2
#: writes it only for a head no earlier load flagged; the loader runs the
#: directive, ten inferences, in every process that loads lib_string [measured
#: 2026-09-25T15:55:38+10:00: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4685273 to 4685974 (+701), every force of a waiting
...
#: RE-PINNED 2026-09-25, 4685974 to 4781882 (+95908), lambdas are named by
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 4781882 to 4781932 (+50), engine/source_loading.pl's
...
#: original's side does not move [measured 2026-09-25T18:42:26+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 4781932 to 4781938 (+6), a sweep of a module's
#: generated predicates retires the records describing each swept predicate,
#: and a release the rest of the module's; the lanes' tree read this twin +3
#: off its pin before the step, an offset that is not this step's, so the pin
#: moves by the step's delta alone [measured 2026-09-25T23:29:52+10:00: one
#: full twins lane before this commit and one with it, the two read on one
#: battery path at the landing's HEAD; command=python
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-26, 4781938 to 4781995 (+57), engine/metta/control.pl's
...
#: arities move it the same; before this change the trunk already read 4781941
#: against the pin 4781938, so 3 of the move is the trunk's own drift and is
#: not attributed here [measured 2026-09-26T01:32:55+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-26, 4781995 to 4782055 (+60), the reference faces of a
