...
#: RE-PINNED 2026-08-25, 28683 to 28688, at the release cut: the
...
#: RE-PINNED 2026-08-26, 28688 to 28205 (-483), by the open-tail-index
...
#: RE-PINNED 2026-09-01, 28225 to 27174 (-1051), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 27174 to 27157 (-17), the subtract-atom primitive and
#: Counter's grain for -=: a new engine head shifts every twin's load
#: structure, the removal doors changed meaning where a twin spells one, and
#: the quad twin stopped being a different program [measured 2026-09-01: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 27157 to 27176 (+19), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 27176 to 27379 (+203), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 27379 to 27363 (-16), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 27363 to 27377 (+14), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 27377 to 29251 (+1874), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 29251 to 33179 (+3928), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 33179 to 33219 (+40), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 33219 to 33184 (-35), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 33184 to 33178 (-6), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 33178 to 33195 (+17), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 33178 to 33706 (+528), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 33706 to 33716 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 33716 to 33735 (+19), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 33195 to 33232 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 33232 to 33755 (+523), the door table landed
...
#: RE-PINNED 2026-09-09, 33755 to 33834 (+79), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 33735 to 34816 (+1081), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 34816 to 34756 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 34756 to 34900 (+144), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 33735 to 33782 (+47), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 33782 to 34849 (+1067), the compiled vocabulary seed,
...
#: tree, -51 against the trunk's own pin of 34900 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +1118 is what
...
#: RE-PINNED 2026-09-09, 34849 to 17399 (-17450), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 17399 to 17409 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-11, 17409 to 17404 (-5), Explicit
...
#: RE-PINNED 2026-09-11, 78285 to 126822 (+48537), String now imports its
...
#: RE-PINNED 2026-09-12, 151609 to 151623 (+14), File transfers newly owned
...
#: RE-PINNED 2026-09-13, 151643 to 151657 (+14), File privately exports its
...
#: RE-PINNED 2026-09-13, 151657 to 152187 (+530), File exports its staged
...
#: RE-PINNED 2026-09-14, 152187 to 174270 (+22083), String now derives nine
...
#: RE-PINNED 2026-09-11, 17404 to 16310 (-1094), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 17404 to 17149 (-255), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 17149 to 17071 (-78), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 17071 to 445869 (+428798), the sixty libraries derived
...
#: RE-PINNED 2026-09-24, 445869 to 472814 (+26945), placed on the full-
...
#: RE-PINNED 2026-09-24, 472814 to 288425 (-184389), 0a81c782f loads a
...
#: RE-PINNED 2026-09-24, 288425 to 289196 (+771), both: 2126ab6 installs the
...
#: RE-PINNED 2026-09-24, 289196 to 300813 (+11617), +11,611 at ae1cc8936, where
...
#: RE-PINNED 2026-09-24, 300813 to 300580 (-233), d4a365c16 holds the support
...
#: RE-PINNED 2026-09-24, 300580 to 300956 (+376), +374 at the change this re-
...
#: RE-PINNED 2026-09-25, 300956 to 300978 (+22), the py-* doors change makes
...
#: (i-arity-walk-all-predicates) [measured 2026-09-25T02:50:24+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 300978 to 300965 (-13), the registration refusal kind
...
#: the base [measured 2026-09-25T06:28:39+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 300965 to 299512 (-1453), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:46:26+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 299512 to 299522 (+10), Runtime.reclaim(), the
...
#: RE-PINNED 2026-09-25, 299522 to 299524 (+2), both specializer doors prepare
...
#: RE-PINNED 2026-09-25, 299524 to 299528 (+4), retiring a library importer
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 299528 to 299538 (+10), lib/lib_string/lib_string.qlf
...
#: lib_string [measured 2026-09-25T15:54:43+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 299538 to 299562 (+24), every force of a waiting
...
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 299562 to 299576 (+14), lambdas are named by their
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 299576 to 299639 (+63), engine/source_loading.pl's
...
#: original's side does not move [measured 2026-09-25T18:41:28+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 299639 to 299641 (+2), a sweep of a module's generated
...
#: battery path at the landing's HEAD; command=python
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-26, 299641 to 299659 (+18), engine/metta/control.pl's
...
#: arities move it the same [measured 2026-09-26T01:30:05+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-26, 299659 to 299679 (+20), the reference faces of a
...
#: 2026-09-26T03:08:05+10:00: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
BUDGET = 299679
