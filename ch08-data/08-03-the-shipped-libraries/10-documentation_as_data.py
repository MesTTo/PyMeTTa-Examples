"""Purpose: examples/ch08-data/08-03-the-shipped-libraries/10-documentation_as_data.metta in Python: what a space has documented.
...
#: RE-PINNED 2026-09-08, 49111 to 49065 (-46), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 49065 to 49022 (-43), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 49022 to 49044 (+22), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 49022 to 49189 (+167), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 49189 to 49149 (-40), The engine and library module
...
#: RE-PINNED 2026-09-08, 49149 to 49372 (+223), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 49044 to 49079 (+35), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 49079 to 49392 (+313), the door table landed
...
#: RE-PINNED 2026-09-09, 49392 to 49634 (+242), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 49372 to 49715 (+343), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 49715 to 49655 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 49655 to 50012 (+357), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 49372 to 49190 (-182), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 49190 to 49234 (+44), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 49234 to 49779 (+545), the compiled vocabulary seed,
...
#: tree, -233 against the trunk's own pin of 50012 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +778 is what landed
...
#: RE-PINNED 2026-09-09, 49779 to 49789 (+10), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 49789 to 49799 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 49799 to 49849 (+50), the Python layout's shim
#: partition (metta/_binding/shim.pl including 34 units, merged as 391763f1c)
#: changed the order SWI's predicate table enumerates the '&metta' storage
#: arities, which spaces:metta_catalog_clause/2 walks with current_predicate/1
#: for a partial-list pattern; every read of the @doc atom of a documented head
#: pays +11 on this tree (five such reads in this twin, measured statement by
#: statement against the pre-merge trunk 3734fc364) and a define pays -5, the
...
#: RE-PINNED 2026-09-11, 49797 to 48872 (-925), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-11, 48872 to 48922 (+50), engine/metta/limits.pl
...
#: RE-PINNED 2026-09-18, 49797 to 51136 (+1339), the branch's landings since
...
#: RE-PINNED 2026-09-18, 51136 to 51086 (-50), 49478d67a landed the polynomial
...
#: RE-PINNED 2026-09-18, 51086 to 50641 (-445), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 50641 to 50673 (+32), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 50673 to 50966 (+293), placed on the full-
...
#: undocumented stopped reporting specializer residues; 6167a0fb2 makes import
...
#: RE-PINNED 2026-09-24, 50966 to 50916 (-50), 5c32234cf, the host-patch split,
...
#: RE-PINNED 2026-09-24, 50916 to 50966 (+50), 0847c3d4c decides a platform
...
#: RE-PINNED 2026-09-24, 50966 to 51137 (+171), -50 at no commit, the same code
...
#: a process allocated first, the -50 the ladder placed on aaeea643a, whose
#: seat 5b0b92274 allocated the functors that shifted that order; +222 at
#: 850d2a660, which reads a native space's lengths in ascending arity rather
#: than functor-hash order; -1 at 0f6d29ba6, the seat's early-exit questions
#: asked by key or in ascending arity [measured 2026-09-24: min-of-3 serial
#: fresh processes at HEAD in battery 118 holding the committed tree alone
...
#: RE-PINNED 2026-09-25, 51137 to 51127 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:28:50+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 51127 to 52373 (+1246), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:46:37+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 52373 to 52374 (+1), every force of a waiting function
