...
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 338833 to 327511 (-11322), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:47:02+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 327511 to 327521 (+10), Runtime.reclaim(), the
...
#: large load (i-arity-walk-all-predicates); the lanes' tree read this twin +6
#: off its pin before the step, an offset that is not this step's, so the pin
#: moves by the step's delta alone [measured 2026-09-25T11:25:25+10:00: one
...
#: RE-PINNED 2026-09-25, 327523 to 327527 (+4), retiring a library importer
#: derives the arity row again from any backing head a library home still
#: registers, journalled to the load that owns it; the lanes' tree read this
#: twin +6 off its pin before the step, an offset that is not this step's, so
#: the pin moves by the step's delta alone [measured 2026-09-25T11:33:06+10:00:
#: one full twins lane before this commit and one with it, the two read on one
#: battery path at the landing's HEAD; command=python
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 327527 to 327537 (+10), lib/lib_string/lib_string.qlf
...
#: lib_string [measured 2026-09-25T15:55:20+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 327537 to 327561 (+24), every force of a waiting
#: function names the module it is made from, through fun_home_in/3, and a
#: write forces only its own space; the lanes' tree read this twin +6 off its
...
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 327561 to 327659 (+98), lambdas are named by their
#: content and a copy restores its source's rows as a program; the lanes' tree
#: read this twin +6 off its pin before the step, an offset that is not this
...
#: RE-PINNED 2026-09-25, 327659 to 327705 (+46), engine/source_loading.pl's
...
#: original's side does not move [measured 2026-09-25T18:42:00+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 327705 to 327707 (+2), a sweep of a module's generated
#: predicates retires the records describing each swept predicate, and a
#: release the rest of the module's; the lanes' tree read this twin +6 off its
#: pin before the step, an offset that is not this step's, so the pin moves by
#: the step's delta alone [measured 2026-09-25T23:29:52+10:00: one full twins
#: lane before this commit and one with it, the two read on one battery path at
#: the landing's HEAD; command=python
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-26, 327707 to 327725 (+18), engine/metta/control.pl's
...
#: arities move it the same [measured 2026-09-26T01:30:29+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-26, 327725 to 327745 (+20), the reference faces of a
...
#: 2026-09-26T03:08:29+10:00: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
BUDGET = 327745
