"""Purpose: examples/ch08-data/08-03-the-shipped-libraries/08-doc_lib.metta in Python: documentation is atoms in a space.
...
#: RE-PINNED 2026-09-01, 9699 to 9021 (-678), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 9021 to 9000 (-21), the subtract-atom primitive and
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 10608 to 8249 (-2359), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 8249 to 8471 (+222), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 8471 to 8523 (+52), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 8523 to 8484 (-39), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 8484 to 8470 (-14), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 8470 to 8501 (+31), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 8470 to 8506 (+36), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 8506 to 8516 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 8516 to 8593 (+77), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 8501 to 8527 (+26), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 8527 to 8624 (+97), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-08, 8593 to 8851 (+258), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 8851 to 8780 (-71), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 8780 to 9003 (+223), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 8593 to 8615 (+22), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 8615 to 8650 (+35), Compile shipped typing decisions
...
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 8650 to 8965 (+315), the compiled vocabulary seed, the
...
#: tree, -38 against the trunk's own pin of 9003 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +353 is what landed
...
#: RE-PINNED 2026-09-09, 8965 to 9002 (+37), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 9002 to 9034 (+32), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 9034 to 9025 (-9), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 9025 to 7978 (-1047), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 9025 to 8632 (-393), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 8632 to 8610 (-22), 49478d67a landed the polynomial
...
#: RE-PINNED 2026-09-18, 8610 to 8460 (-150), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 8460 to 8540 (+80), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 8540 to 12525 (+3985), placed on the full-
...
#: from the module that owns it; the commits 63fc952ac..8d45268e3, which the
#: ladder did not split; their runtime changes are 31c0afd8a (the host
#: refusal's message), 7472c4907, which marks a module's reference face dirty
#: instead of walking its forward closure, so support_stabilize/3 walks the
#: face's dependents only when the recomputed value moved and an event that
#: changes nothing recompiles no caller, 7054c11f7, which carries lib 62ca61c's
#: bisecting bit length in _support/statistics.metta, and the Python-seat
#: pointers; da91bc244 confines an exact removal's selection to its own atom:
...
#: on the library twins that withdraw package rows); where a twin's move
...
#: RE-PINNED 2026-09-24, 12525 to 12547 (+22), 0847c3d4c decides a platform
...
#: RE-PINNED 2026-09-24, 12547 to 12589 (+42), -11 at no commit, the same code
#: read in battery 117's path against battery 115's: before 850d2a660 this
#: count followed the functor-hash order of its open reads, which follows what
#: a process allocated first; +54 at 850d2a660, which reads a native space's
#: lengths in ascending arity rather than functor-hash order; -1 at 0f6d29ba6,
#: the seat's early-exit questions asked by key or in ascending arity [measured
...
#: RE-PINNED 2026-09-24, 12589 to 12566 (-23), gate-perf's d781eab8f carries an
...
#: RE-PINNED 2026-09-25, 12566 to 12551 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:28:45+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 12551 to 12671 (+120), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:46:32+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 12671 to 12672 (+1), every force of a waiting function
...
#: IS a (: name (-> ...)) row and a docstring on a compiled function IS an
#: (@doc name ...) row, so the twin's space carries the declarations and the
...
DIVERGENCE = "4926bcbed6ed40537464c4a8548f434d010d6559c4a7327a091bb29f0f1ab151"
