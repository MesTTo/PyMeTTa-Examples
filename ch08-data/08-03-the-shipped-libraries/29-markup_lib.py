...
#: RE-PINNED 2026-09-25, 133795 to 131758 (-2037), the host evaluation door
...
#: --repin].
#: RE-PINNED 2026-09-25, 131758 to 131728 (-30), the switch of the
#: swipl-patched prefix from .5 to .6: loading library(xpath) costs 7119
#: inferences on .6 against 7149 on .5, because .5's
...
#: RE-PINNED 2026-09-25, 131744 to 131777 (+33), engine/source_loading.pl's
...
#: original's side does not move [measured 2026-09-25T18:42:34+10:00: min-of-3
