...
#: RE-PINNED 2026-09-02, 61490 to 61714 (+224), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 61714 to 61865 (+151), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 61865 to 65955 (+4090), trunk's own movement since
...
#: RE-PINNED 2026-09-08, 65955 to 65949 (-6), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 65949 to 65906 (-43), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 65906 to 69472 (+3566), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 69472 to 69791 (+319), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 70875 to 71476 (+601), tokens as storage landed
...
#: RE-PINNED 2026-09-09, 71476 to 24807 (-46669), a library's Prolog half
...
#: RE-PINNED 2026-09-09, 24807 to 24799 (-8), Public add-atom calls
...
#: RE-PINNED 2026-09-18, 24799 to 26480 (+1681), the branch's landings since
...
#: RE-PINNED 2026-09-18, 26480 to 26343 (-137), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 26343 to 458981 (+432638), the sixty libraries derived
...
#: RE-PINNED 2026-09-24, 458981 to 489262 (+30281), placed on the full-
...
#: RE-PINNED 2026-09-24, 489262 to 288301 (-200961), 0a81c782f loads a
...
#: RE-PINNED 2026-09-24, 288301 to 288930 (+629), 2126ab6 installs every
...
#: RE-PINNED 2026-09-24, 288930 to 300466 (+11536), +11,519 at ae1cc8936, where
...
#: inference fewer than the AVL; +10 at 850d2a660, which reads a native space's
...
#: RE-PINNED 2026-09-24, 300466 to 300210 (-256), d4a365c16 holds the support
...
#: for each equation removal the twin adopts and 4 for each it selects (-277);
...
#: Prolog (+23); each step read serially on its own committed tree, from gate-
...
#: RE-PINNED 2026-09-24, 300210 to 300589 (+379), +377 at the change this re-
...
#: RE-PINNED 2026-09-25, 300589 to 300610 (+21), the py-* doors change makes
...
#: [measured 2026-09-25T02:56:11+10:00: min-of-3 serial fresh processes;
#: command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 300610 to 298024 (-2586), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:46:23+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 298024 to 298034 (+10), Runtime.reclaim(), the
...
#: RE-PINNED 2026-09-25, 298034 to 298036 (+2), both specializer doors prepare
...
#: RE-PINNED 2026-09-25, 298036 to 298040 (+4), retiring a library importer
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 298040 to 298049 (+9), lib/lib_string/lib_string.qlf
...
#: without the change, inside its allowance, where the host switch to swipl-
...
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 298074 to 298088 (+14), lambdas are named by their
...
#: with it, the two read on one battery path at the landing's HEAD;
#: command=python extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-25, 298088 to 298138 (+50), engine/source_loading.pl's
...
#: original's side does not move [measured 2026-09-25T18:41:25+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 298138 to 298139 (+1), a sweep of a module's generated
...
#: battery path at the landing's HEAD; command=python
#: extensions/python/tools/twin_coverage.py].
#: RE-PINNED 2026-09-26, 298139 to 298157 (+18), engine/metta/control.pl's
...
#: arities move it the same [measured 2026-09-26T01:30:02+10:00: min-of-3
#: serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-26, 298157 to 298178 (+21), the reference faces of a
...
#: 2026-09-26T03:07:59+10:00: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin].
BUDGET = 298178
