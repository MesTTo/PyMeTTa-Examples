"""Purpose: examples/ch08-data/08-01-atoms-lists-and-folds/05-lambda.metta in Python: two kinds of lambda.
...
#: RE-PINNED 2026-08-26, 48408 to 48332 (-76), on the composed
...
#: RE-PINNED 2026-08-26, 48268 to 46781 (-1487), by the specializer
...
#: RE-PINNED 2026-09-01, 46781 to 22922 (-23859), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 22922 to 22851 (-71), the subtract-atom primitive and
...
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 23499 to 22045 (-1454), the one pricing pass at the
...
#: RE-PINNED 2026-09-07, 22045 to 22625 (+580), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 22625 to 22690 (+65), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 22690 to 22316 (-374), metta_substitute_self/3 probes
...
#: RE-PINNED 2026-09-08, 22316 to 22299 (-17), the evaluation-fuel scope marker
...
#: RE-PINNED 2026-09-08, 22299 to 22336 (+37), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 22299 to 22366 (+67), The engine and library
#: predicates now resolve through their owning modules and the explicit engine
#: facade; compiled program lookup crosses the added metta_engine tier
#: [measured 2026-09-08: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=ede2ac57e213a0d4502c6bbbca6227f97015b720].
#: RE-PINNED 2026-09-08, 22366 to 22376 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 22376 to 22429 (+53), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 22336 to 22389 (+53), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 22389 to 22467 (+78), the door table landed
...
#: RE-PINNED 2026-09-09, 22467 to 22563 (+96), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 22429 to 23212 (+783), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 23212 to 23152 (-60), Sharing the fast-image
...
#: RE-PINNED 2026-09-09, 23152 to 23331 (+179), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 22429 to 22480 (+51), Compiled shipped typing
...
#: RE-PINNED 2026-09-09, 22480 to 22982 (+502), Compile shipped typing
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 22982 to 23789 (+807), the compiled vocabulary seed,
...
#: tree, +458 against the trunk's own pin of 23331 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +349 is what landed
...
#: RE-PINNED 2026-09-09, 23789 to 23849 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 23849 to 23859 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-09, 23859 to 23827 (-32), Public add-atom calls
...
#: RE-PINNED 2026-09-11, 23827 to 23381 (-446), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 23827 to 24722 (+895), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 24722 to 24296 (-426), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 24296 to 24449 (+153), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 24449 to 24441 (-8), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 24441 to 24426 (-15), the registration refusal kind
...
#: the base [measured 2026-09-25T06:28:09+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 24426 to 25423 (+997), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:45:13+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 25423 to 25429 (+6), both specializer doors prepare a
...
#: RE-PINNED 2026-09-25, 25429 to 25430 (+1), every force of a waiting function
...
#: RE-PINNED 2026-09-25, 25430 to 26135 (+705), lambdas are named by their
...
#: the twin holds 7 atoms the example does not (4 =, 3 @python-callable): a
#: compiled body spells a positional call of a bound callee as the plain
#: application and a lambda bare where it is applied (e59104ace), so the twin's
#: stored equations meet the example's spelling where they did not, and where
#: they still differ the twin stores what its own Python spelling stores
#: [measured 2026-09-18: the two stored-atom surpluses, one fresh process per
#: side; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=6944d06ce96fdbcd1faefb640f15dbfa0cf286dd].
#: DIVERGED 2026-09-25, the example holds 0 atoms the twin does not (none) and
#: the twin holds 7 atoms the example does not (4 =, 3 @python-callable): a
