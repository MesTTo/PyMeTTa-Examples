...
#: RE-PINNED 2026-09-09, 11530425 to 11530488 (+63), The fixed diagnostic
#: reader now consumes parameter and argument spines together, and segment
#: families compile once per shape. Fixed-arrow presentation and warmed single-
#: run callees keep their controls. Fused syntax admission adds 44 inferences
#: for a cold prepare/admit type shape versus the old annotation scan and eight
#: per source-preflight declaration; repeated shapes reuse the analysis. The
