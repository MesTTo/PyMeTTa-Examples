"""Purpose: examples/ch08-data/08-01-atoms-lists-and-folds/01-nestedcons.metta in Python: two cons cells in one pattern.
...
#: RE-PINNED 2026-08-25, 5105 to 5124, at the flat-door
...
#: RE-PINNED 2026-08-25, 5124 to 5135, on the QLF-boot final
...
#: RE-PINNED 2026-08-25, 5135 to 5069, on the release tree:
...
#: RE-PINNED 2026-08-25, 5069 to 5079, at the release cut: the
...
#: RE-PINNED 2026-08-26, 5079 to 6535 (+1456), by the open-tail-index
...
#: RE-PINNED 2026-08-26, 6535 to 6555 (+20), on the composed
#: async-scheduler tree: a live operation call pays the six-inference
#: admission probe the baseline's p14_async_scheduler_comment prices,
#: and the scheduler, context-callback and exact-memo lifecycle clauses
#: move compiled-image layout by tens, the class this file's chain
#: documents [measured: min-of-3 serial fresh processes; command=python extensions/python/tools/twin_coverage.py --measure --rounds 3; fixture=merged p14-audit-async composed tree with engine/reader.so; commit=5059173b1767600ce4df0f6b7841d88116ee62d3].
#: RE-PINNED 2026-08-26, 6555 to 5115 (-1440), by the specializer
...
#: RE-PINNED 2026-09-01, 5115 to 3908 (-1207), the compiled-language batch:
...
#: RE-PINNED 2026-09-01, 3908 to 3897 (-11), the subtract-atom primitive and
#: the Counter grain for -=: a new engine head shifts every twin's load
#: structure, and the removal doors changed meaning where a twin spells one
#: [measured 2026-09-01: min-of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c6a40460b1db341198a6150e3600f502831a6e83].
#: RE-PINNED 2026-09-01, 3897 to 3905 (+8), generic Python operators now
#: dispatch through live protocols while source twins explicitly name
#: relational engine heads [measured 2026-09-01: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=e3787593132a7ece2d300397045f7415709847c9].
#: RE-PINNED 2026-09-02, 3905 to 3951 (+46), static contract discharge and
#: policy-stable recompilation [measured 2026-09-02: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3951 to 3939 (-12), static contract discharge with
#: policy checks confined to invalidated contracts [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-02, 3939 to 3949 (+10), P43 protects both generated
#: policy-check fallbacks from space-local capture [measured 2026-09-02: min-
#: of-3 serial fresh processes; command=python
#: extensions/python/tools/twin_coverage.py --repin; commit=c00341f0ff9d83d1b9338ca86ad51708eaf07ebd].
#: RE-PINNED 2026-09-06, 3949 to 3365 (-584), the one pricing pass at the 0.8.0
...
#: RE-PINNED 2026-09-07, 3365 to 3464 (+99), trunk's own movement since each
...
#: RE-PINNED 2026-09-08, 3464 to 3502 (+38), the merges between this lane's
...
#: RE-PINNED 2026-09-08, 3502 to 3452 (-50), metta_substitute_self/3 probes the
...
#: RE-PINNED 2026-09-08, 3452 to 3467 (+15), boot content moved: the refusal
...
#: RE-PINNED 2026-09-08, 3452 to 3458 (+6), The engine and library predicates
...
#: RE-PINNED 2026-09-08, 3458 to 3468 (+10), The engine and library module
...
#: RE-PINNED 2026-09-08, 3468 to 3445 (-23), the module boundary merged with
...
#: RE-PINNED 2026-09-08, 3467 to 3504 (+37), The typed host door catalog is
...
#: RE-PINNED 2026-09-09, 3504 to 3465 (-39), the door table landed (feat/space-
...
#: RE-PINNED 2026-09-09, 3465 to 3493 (+28), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 3445 to 3594 (+149), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-08, 3594 to 3534 (-60), Sharing the fast-image hexadecimal
...
#: RE-PINNED 2026-09-09, 3534 to 3627 (+93), tokens as storage landed
...
#: RE-PINNED 2026-09-08, 3445 to 3492 (+47), Compiled shipped typing decisions
...
#: RE-PINNED 2026-09-09, 3492 to 3530 (+38), Compile shipped typing decisions
...
#: extensions/python/tools/twin_coverage.py --repin; commit=32650f9ff4d1c4aa0749d8eb8b153e5bb448ee5c].
#: RE-PINNED 2026-09-09, 3530 to 3617 (+87), the compiled vocabulary seed, the
...
#: tree, -10 against the trunk's own pin of 3627 at da0e5755d; the previous
#: number is the branch's cut-time price, and the remaining +97 is what landed
...
#: RE-PINNED 2026-09-09, 3617 to 3677 (+60), a library's Prolog half compiles
...
#: RE-PINNED 2026-09-09, 3677 to 3687 (+10), engine/qlf_boot.pl gained the
...
#: RE-PINNED 2026-09-10, 3687 to 2459 (-1228), the binding resolves Janus
...
#: RE-PINNED 2026-09-10, 2459 to 2454 (-5), the bounds frame watcher now
...
#: RE-PINNED 2026-09-10, 2454 to 2459 (+5), automatic memo reconciliation uses
...
#: extensions/python/tools/twin_coverage.py --repin; commit=8358dfc233bf299bb23eceddd94593a62372fe4b].
#: RE-PINNED 2026-09-11, 2459 to 2538 (+79), end-of-wave re-pin on the merged
...
#: RE-PINNED 2026-09-18, 2459 to 2696 (+237), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 2696 to 2662 (-34), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-21, 2662 to 2682 (+20), the sixty libraries derived in
...
#: RE-PINNED 2026-09-24, 2682 to 2689 (+7), placed on the full-configuration
...
#: RE-PINNED 2026-09-25, 2689 to 2679 (-10), the registration refusal kind
...
#: the base [measured 2026-09-25T06:27:58+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2679 to 2635 (-44), the host evaluation door replaces
...
#: twelve names [measured 2026-09-25T06:45:02+10:00: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin].
#: RE-PINNED 2026-09-25, 2635 to 2636 (+1), every force of a waiting function
...
#: extensions/python/tools/twin_coverage.py --repin; commit=9010a79b01c9b2a66b96a3952fa378fb3e939dc3].
DIVERGENCE = "4d303d7cb2e122e8285fecce929e5ec0d221ba05435f355398354cb0aee336d0"
