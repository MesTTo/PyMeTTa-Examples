"""Purpose: examples/ch08-data/08-01-atoms-lists-and-folds/08-alpha_member.metta in Python: membership modulo renaming.
...
#: RE-PINNED 2026-09-08, 24060 to 24383 (+323), the module boundary merged with
...
#: RE-PINNED 2026-09-09, 24383 to 24775 (+392), structured concurrency landed
...
#: RE-PINNED 2026-09-08, 24383 to 24572 (+189), Trailing occurrence arguments,
#: token allocation in native writes, exact source withdrawal and transaction-
#: safe shared-table guards change the engine work priced by this twin; answer
#: bags retain the upstream law [measured 2026-09-08: min-of-3 serial fresh
#: processes; command=python extensions/python/tools/twin_coverage.py --repin;
#: commit=7f00ac7932fefa6f380fc8d14ec583ea0c58eff4].
#: RE-PINNED 2026-09-09, 24572 to 24964 (+392), tokens as storage landed
...
#: RE-PINNED 2026-09-10, 25940 to 25688 (-252), the binding resolves Janus
...
#: RE-PINNED 2026-09-11, 25688 to 26458 (+770), end-of-wave re-pin on the
...
#: RE-PINNED 2026-09-18, 25688 to 25555 (-133), the branch's landings since the
...
#: RE-PINNED 2026-09-18, 25555 to 25408 (-147), the trunk merged (f97c4b0a3,
...
#: RE-PINNED 2026-09-25, 25408 to 24286 (-1122), the host evaluation door
...
#: more than twelve names [measured 2026-09-25T06:45:21+10:00: min-of-3 serial
#: fresh processes; command=python extensions/python/tools/twin_coverage.py
#: --repin].
#: RE-PINNED 2026-09-25, 24286 to 24287 (+1), every force of a waiting function
...
#: OVERRUN 2026-09-08, 3600 to 3909 (+309): the module boundary merged with
...
#: crossing this twin makes pays it and the example pays none. Measured 24383
...
#: OVERRUN 2026-09-10, 5446 to 6224: The existing program is priced after the
#: reference census, ordered catalog reads and source-scoped translation
#: work. It costs 26711 against the unchanged band and authoring ceiling of
#: 20487.5. The literal structured control costs 26040; it measures that
#: encoding only. [measured 2026-09-10: one fresh process per side;
#: command=python extensions/python/benchmarks/probes/twin_floor.py
#: examples/ch08-data/08-01-atoms-lists-and-folds/08-alpha_member.metta;
